    							...
    							<div class="col-lg-6 col-12 col-md-6  text-left">
    								 <div class="lendl-cardwrap">
    								     <div class="tri-imagewrap">
        								    <img src="public/images/aris-360-home-loans-profile.png" class="img-360 mb-2" alt="">
    								     </div>
    								     <div class="lendl-carddetail">
							            	<h5 class="mb-0 text-left">
                								<span class="tristart-text">Aris360 Home Loans</span>
						...
						<div class="in-blog-details-content-area">
							...
							<div class="in-blog-details-text-area about-wrapper headline ul-li-block pera-content">
								<div class="in-blog-details-text-wrap">
									...
									<h3>About Aris360 Home Loans</h3>

									<!--<div class="collapse collapse_show_less" id="collapseCompanyDetails">-->
									<div class="about-text-wrap">
											<p>Aris360 Home Loans is a national lender for borrowers who want to work with a great lender that goes above and beyond for them!</p>
										<!--<blockquote>-->
									...
									<ul>
										<li>
											<a href="#">
												...
												5209 Lake Washington Blvd NE <br> Suite 220 Kirkland, WA 98033
											</a>
										</li>
									</ul>
								</div>
									...
									<li>
										<div class="comment_element">
											...
											<div class="comment_content pera-content mt-2" style="border-bottom: unset !important;">
												<div class="reviews-headwrapper">
												    <h4 class="review-headtext"><a href="#">Thoroughly service oriented</a></h4>
												    <span>12/18/2022</span>
												</div>
												<p class="review-gentext">W. Chambers from Eloy, AZ</p>
												<p>They were great during our pre-qualification, house hunting and offer and negotiation process. They provided a lot of help that I’d never have gotten. I knew I could call them any time and get questions answered. True service.</p>
											</div>
										</div>
									</li>
								 	...
								 	<li>
										<div class="comment_element">
											...
											<div class="comment_content pera-content mt-2" style="border-bottom: unset !important;">
												<div class="reviews-headwrapper">
												    <h4 class="review-headtext"><a href="#">Great partner over the years</a></h4>
												    <span>12/18/2022</span>
												</div>
												<p class="review-gentext">zuser201407031634061 from Seattle, WA</p>
												<p>They have been helping me and my partner navigate the home loan process since 2019. We got pre-qualed over the summer of 2020 and were able to transact quickly on a home that summer during an insanely competitive market. Our loan closed quickly and we were able to secure the home we wanted in Seattle.

Since then, They have continued to be a point of contact answering questions for us.

Highly recommend. Deeply appreciative of their's patience working with a first time home buyer!</p>
											</div>
										</div>
									</li>
