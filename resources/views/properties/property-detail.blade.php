...
.collapse_wrap {
    ...
    .ribbon {
        ...
        background-color: #ffde22; /* Adjust the background color as needed */
        color: #fff;
        padding: 5px 10px;
        font-size: 14px;
        font-weight: bold;
        ...
        <div class="container">
            <div class="property_section_list">
                <ul>
                    ...
                    @if (($Details['canaryData'][0]['property/sales_history']['result'] ?? null) !== null)
                    <li>
                        <a href="#taxHistory" hre>Tax History </a>
                    </li>
                    @endif
                    @if(isset($Details['SchoolDetails']['schools']) && count($Details['SchoolDetails']['schools']) > 0)
                    <li>
                        <a href="#schoolData">School</a>
                    </li>
                    @endif
                    @if (isset($Details['canaryData'][0]['property/value']['result']['value']))
                    <li>
    ...
    @if ($Details['properties']->PublishStatus != 'Sold' && $Details['properties']->PublishStatus != 'Closed')
        @if (isset($Details['properties']->ListingContractDate))
            <div class="container">
                <div class="category5"> Days On Market:
                    {{ getTimeSinceCreation($Details['properties']->ListingContractDate) }}
                    Days</div>
            </div>
        @endif
    @endif
                                    ...
                                    <div class="col-lg-8 col-md-8 col-12">
                                        <div class="property_main_img">
                                            ...
                                            <a href="javascript:void(0)" data-toggle="modal"
                                                ...
                                                <img id="" class="lazy"
                                                    src="{{ $Details['topThreeMedia'][0]['s3buckettempurl'] }}"
                                                    alt="">
                                                    @if(isset($Details['openHouse']) && count($Details['openHouse']) > 0)
                                                    @php
                                                        $openHouseStartTime = \Carbon\Carbon::parse($Details['openHouse']['openHouseStartTime']);
                                                        $openHouseEndTime = \Carbon\Carbon::parse($Details['openHouse']['openHouseEndTime']);
                                                        $openHouseDate = \Carbon\Carbon::parse($Details['openHouse']['openHouseDate']);
                                                        $today = \Carbon\Carbon::now();
                                                        if ($openHouseDate->isToday()) {
                                                            $formattedTime = $openHouseStartTime->format('h:i A') . ' - ' . $openHouseEndTime->format('h:i A');
                                                            $formattedDateTime = "Open Today {$formattedTime}";
                                                        } else {
                                                            $dayOfWeek = $openHouseDate->format('l'); // Get the full day name
                                                            $formattedTime = $openHouseStartTime->format('h:i A') . ' - ' . $openHouseEndTime->format('h:i A');
                                                            $formattedDateTime = "Open {$dayOfWeek} {$formattedTime}";
                                                        }
                                                    @endphp
                                                    <div class="ribbon"> {{ $formattedDateTime }}</div>
                                                    @endif
                                            ...
                                            <div class='btnCont'>
                                                ...
                                                @if (isset($Details['PropertyOtherDetails']->VirtualTourURLUnbranded) &&
                                                        !empty($Details['PropertyOtherDetails']->VirtualTourURLUnbranded))
                                        ...
                                        @if (isset($Details['topThreeMedia'][1]))
                                            <div class="property_main_img2">
                                                <a href="javascript:void(0)" data-toggle="modal"
                                                    data-target="#propertyDetailimg">
                                                    <img id="" class="lazy"
                                                        src="{{ $Details['topThreeMedia'][1]['s3buckettempurl'] }}"
                                                        alt="">
                                                </a>
                                            </div>
                                        @endif
                                        @if (isset($Details['topThreeMedia'][2]))
                                            <div class="property_main_img2">
                                                <a href="javascript:void(0)" data-toggle="modal"
                                                    data-target="#propertyDetailimg">
                                                    <img id="" class="lazy"
                                                        src="{{ $Details['topThreeMedia'][2]['s3buckettempurl'] }}"
                                                        alt="">
                                                </a>
                                            </div>
                                        @endif
                                    </div>
                                    <a class="all_photos" href="javascript:void(0)" data-toggle="modal"
                                        data-target="#propertyDetailimg">see all
                                        {{ (isset($Details['countMedia']) && isset($Details['countMedia'][0])  && $Details['countMedia'][0]['media_count'] > 0) ? $Details['countMedia'][0]['media_count'] : 'N/A' }}
                                        photos</a>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-12">
                                <div class="smallInfo">
                                    <div class="proprty_status">
                                        <h5>
                                            @if ($Details['properties']->PublishStatus == 'Sold' || $Details['properties']->PublishStatus == 'Closed')
                                                SOLD On
                                                {{ isset($Details['PropertyOtherDetails']->ContractStatusChangeDate) ? dateTostring($Details['PropertyOtherDetails']->ContractStatusChangeDate) : '' }}
                                            @else
                                                {{ isset($Details['properties']->PublishStatus) ? $Details['properties']->PublishStatus : '' }}
                                            @endif
                                        </h5>
                                    </div>
                                    <div class="propertyInfo">
                                        @if (isset($Details['properties']->IsMlsProperty) && $Details['properties']->IsMlsProperty == 1)
                                            <p>
                                                ...
                                                {{ isset($Details['properties']->ListOfficeName) ? $Details['properties']->ListOfficeName : '' }}:
                                                {{ isset($Details['properties']->ListAgentFullName) ? $Details['properties']->ListAgentFullName : '' }}

                                            </p>
                                        @endif
                                        <span>NWMLS # {{ str_replace('NWM', '', $Details['properties']->ListingId) }}
                                        </span>
                                ...
                                <div class="property_detail_bttm_sect">
                                        ...
                                        <div class="price_section">
                                            <div class="price_section_left">
                                                <h3 class="property_priceNew">
                                                    @if ($Details['properties']->PublishStatus == 'Sold' || $Details['properties']->PublishStatus == 'Closed')
                                                        ${{ isset($Details['properties']->ClosePrice) ? number_format($Details['properties']->ClosePrice) : $Details['properties']->PropetySellPrice }}
                                                    @else
                                                ...
                                                <div class="price_section2">
                                                    <div class="author-info clearfix">
                                                        <ul class="rating est-monthly clearfix pull-left">
                                                            <li>
                                                                <a class="theme-btn-payment" href="">Est.
                                    ...
                                    @if (isset($Details['properties']->IsMlsProperty) && $Details['properties']->IsMlsProperty == 1)
                                        <small class="mt-2 mb-0">Listings with the three tree icon are courtesy of
                                            NWMLS<span class="property_small_img">
                                                <img src="{{ asset('public/assets/images/NWMLS2.jpeg') }}"
                                                    class="img-fluid">
                                            </span></small>
                                    @endif
                                    ...
                                    <div class="location-box content-widget">
                                        ...
                                        <ul class="info virtual_loc clearfix">
                                            <li>
                                                <span>Country:</span>
                                                @if (!empty($Details['PropertyOtherDetails']->Country))
                                                    {{ $Details['PropertyOtherDetails']->Country }}
                                            </li>
                                            @endif
                                            </li>
                                            <li><span>Neighborhood:</span>
                                                @if (!empty($Details['PropertyOtherDetails']->StreetName))
                                                    {{ $Details['PropertyOtherDetails']->StreetName }}
                                            </li>
                                            @endif
                                                                ...
                                                                <div class="PaymentSection_modal_inner">
                                                                    ...
                                                                    <div class="payment_label_input">
                                                                        ...
                                                                        <div class="payment_label_input2">
                                                                            <input onchange="calculatePercentageDownPay()"
                                                                                id="downpay"
                                                                    ...
                                                                    <div class="cashPayment_range">
                                                                        <input onchange="DownpayRange()" id="downpayRange"
                                                                            type="range" value="10000" min="0"
                                                                            max="1000000" step="1"
                                                                            class="progresss">
                                                                    </div>
                                                        ...
                                                        <div class="defaultpanel_LoanDetailValue">
                                                            ...
                                                            <div class="LoanDetailValue_modal">
                                                                <div class="PaymentSection_modal_inner">
                                                                    ...
                                                                    <a href="javascript:void(0)" class="interestclose"><i
                                                                            class="fas fa-times"></i></a>
                                                                    <div class="payment_label_input">
                                                                        <div class="payment_label_input2">
                                                                            <input onchange="InterestInput()"
                                                                                class="home_price_input" id="loanInput"
                                                                                type="text" value="0">
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="loan__type__radio">
                                                                            <div class="custom-control custom-radio">
                                                                                <input type="radio" value="30"
                                                                                    id="LoanType1" onclick="RadioChange()"
                                                                                    name="loantypeRadio"
                                                                            ...
                                                                            <div class="custom-control custom-radio">
                                                                                <input type="radio" value="25"
                                                                                    onclick="RadioChange()" id="LoanType2"
                                                                                    name="loantypeRadio"
                                                                                    class="custom-control-input">
                                                                                <label class="custom-control-label"
                                                                            ...
                                                                            <div class="custom-control custom-radio">
                                                                                <input type="radio" value="5"
                                                                                    onclick="RadioChange()" id="LoanType3"
                                                                                    name="loantypeRadio"
                                                                                    class="custom-control-input">
                                                                                <label class="custom-control-label"
                                                                    ...
                                                                    <div class="payment_label_input">
                                                                        ...
                                                                        <div class="payment_label_input2">
                                                                            <input onchange="onchangeHOA()" id="hoa"
                                                                                class="payment_label_input_border"
                                                                                type="text" value="0">
                                                                            <input class="payment_label_input2_notBorder"
                                                                                type="text" value="0%">
                                                                        </div>
                                                                    </div>
                                                                    <div class="payment_label_input">
                                                    ...
                                                    <div class="mt-4">
                                                        <div class="row">
                                                            <div class="col-md-8 col-lg-8 col-sm-12">
                                                                ...
                                                                <span
                                                                    class="ml-5">{{ $Details['electricity']['min_usage'] }}
                                                                    kWh</span>
                                                            </div>
                                                        </div>
                                    ...
                                    @if (isset($Details['fourSquareData']) && !empty($Details['fourSquareData']))
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade placesModal" id="places_modal" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered places-modal-wrapper"
                                                ...
                                                <div class="modal-content ">
                                                    ...
                                                    <div class="modal-body">
                                                        <ul class="custom-tabs">
                                                            @foreach ($Details['fourSquareData'] as $category => $places)
                                                                <li class="custom-tab-link {{ $loop->first ? 'active' : '' }}"
                                                                    data-tab="{{ str_replace(' ', '-', strtolower($category)) }}-tab">
                                                                    {{ $category }}
                                                        ...
                                                        @foreach ($Details['fourSquareData'] as $category => $places)
                                                            <div id="{{ str_replace(' ', '-', strtolower($category)) }}-tab"
                                                                    ...
                                                                    @foreach ($places as $place)
                                                                        <div class="col-lg-6 p-3">
                                                                            <div class="content-wrapper">
                                                                                <div class="thumb">
                                                                                    <div class="thumb-load skeleton"></div>
                                                                                </div>
                                                                                <div class="content">
                                                                                    <h1>{{ $place['name'] }}</h1>
                                                                                    <p>
                                    ...
                                    <div class="ask_agent_question">
                                        <h2 class="property_feature text-capitalize">Connect with an ARIS360 Prime Agent
                                        </h2>
                                        <div class="ask_agent_question_sect">
                                            <div class="agent_prof_detail">
                                                @if (!empty($Details['agent_details']))
                                                    <div class="agent_pf_photo">
                                                        <img src={{ asset('public/images/userdp/' . $Details['agent_details'][0]['user_dp']) }}
                                                            alt="">
                                                    </div>
                                                    <div class="agent_pf_mainDetail">
                                                        <p class="titleName">
                                                            {{ ucfirst($Details['agent_details'][0]['first_name']) . ' ' . ucfirst($Details['agent_details'][0]['last_name']) }}
                                                        </p>
                                                        <p class="desc_title">Prime Agent</p>
                                                        <p class="desc_title"><i class="fas fa-envelope"></i><a
                                                                href="emailto:{{ $Details['agent_details'][0]['email'] }}">{{ $Details['agent_details'][0]['email'] }}</a>
                                                        </p>
                                                        <p class="desc_title"><i class="fas fa-phone-volume"></i><a
                                                                href="telto:206-240-8514">{{ $Details['agent_details'][0]['mobile_number'] }}</a>
                                                        </p>
                                                        <p class="desc_title">Responds in a few minutes</p>
                                                    </div>
                                                @else
                                                    <div class="agent_pf_photo">
                                                        <img src={{ asset('/public/assets/images/seth_raddue.png') }}
                                                            alt="">
                                                    </div>
                                                    <div class="agent_pf_mainDetail">
                                            ...
                                            <div class="ask_agent_question_area">
                                                <textarea name="aksquestionzks" id="zksquestxtar" placeholder="Write A Message..."></textarea>
                                            </div>
                                            <input type="hidden" value="{{ csrf_token() }}" id="zkscrsr">
                                            <input type="hidden" value="{{ $Details['properties']->id }}"
                                                id="prprtyId">
                                            @if (!empty($Details['agent_details']))
                                                <input type="hidden" value="{{ $Details['agent_details'][0]['email'] }}"
                                                    id="emailID">
                                                <input type="hidden" value="{{ $Details['agent_details'][0]['id'] }}"
                                                    id="agentID">
                                                <input type="hidden"
                                                    value="{{ ucfirst($Details['agent_details'][0]['first_name']) . ' ' . ucfirst($Details['agent_details'][0]['last_name']) }}"
                                                    id="agentUserName">
                                            @else
                                            ...
                                            @endif
                                            <div class="btn-box">
                                                <a href="javascript:void(0)" class="theme-btn btn-one" id="zkssaque">Ask
                                                    a question</a>
                                            </div>
                                    ...
                                    <div class="advertise_banner">
                                        <a href="https://www.docudash.net" target="_blank">
                                            <img class="lazy"
                                                src="{{ asset('public/assets/images/banner-tolet2.png') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    ...
                                    <div class="advertise_banner">
                                        <a href="https://www.tristarfinance.com" target="_blank">
                                            <img class="lazy"
                                                src="{{ asset('public/assets/images/tristar_banner.jpeg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    ...
                                    <div class="details-box content-widget">
                                        ...
                                        <ul>
                                            ...
                                            @if (
                                                !empty($Details['PropertyOtherDetails']->NWM_WaterHeaterLocation) and
                                                    isset($Details['PropertyOtherDetails']->NWM_WaterHeaterType))
                                                <li class="property_ft_list">
                                                    <h5>Water Heater</h5>
                                                    <div class="property_detail_listing_sect">
                                                        <ul class="property_detail_listingfl">
                                                            ...
                                                            <li class="nav-item">
                                                                @if (
                                                                    ...
                                                                    <a class="nav-link active" id="pills-sale-tab"
                                                                        data-toggle="pill" href="#pills-sale"
                                                                        role="tab" aria-controls="pills-sale"
                                                            ...
                                                            @if (
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link" id="pills-tax-tab"
                                                                        data-toggle="pill" href="#pills-tax"
                                                                        role="tab" aria-controls="pills-tax"
                                                                        aria-selected="false">
                                                                        Tax History
                                                                    </a>
                                                                </li>
                                                                        ...
                                                                        {{-- <section class="cd-horizontal-timeline">
                                                                            <div class="timeline">
                                                                                <div class="events-wrapper">
                                                                                    <div class="events">
                                                                                        <ol>
                                                                                            @foreach ($Details['canaryData'][0]['property/sales_history']['result'] as $key => $saleTaxmainLink)
                                                                                                <li>
                                                                            ...
                                                                            <div class="events-content">
                                                                                <ol>
                                                                                    @foreach ($Details['canaryData'][0]['property/sales_history']['result'] as $saleTaxmainLink)
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            @if (
                                                                                ...
                                                                                <table class="table table-hover">
                                                                                    ...
                                                                                    <tbody>
                                                                                        @foreach ($Details['canaryData'][0]['property/sales_history']['result'] as $taxData)
                                                                                            <tr>
                                                                                                <td>{{ $taxData['record_date'] }}
                                                                                                </td>
                                                                                                <td>{{ isset($taxData['amount']) ? '$' . number_format($taxData['amount']) : 'NULL' }}
                                                                                                </td>
                                                                                                <td>
                                                                                                    ${{ number_format($taxData['fips']) }}
                                                                                                </td>
                                                                                            </tr>
                                                                                        @endforeach
                                                                    ...
                                                                    <div class="tax_history_listtable">
                                                                        <div class="table-responsive">
                                                                            <table class="table table-hover">
                                                                                ...
                                                                                <tbody>
                                                                                    @foreach ($Details['canaryData'][0]['property/tax_history']['result']['tax_history'] as $taxData)
                                                                                        <tr>
                                                                                            <td>{{ $taxData['tax_year'] }}
                                                                                            </td>
                                                                                            <td>
                                                                                                ${{ number_format($taxData['tax_amount']) }}
                                                                                            </td>
                                                                                            <td>
                                                                                                ${{ number_format($taxData['total_assessed_value']) }}
                                                                                            </td>
                                                                                        </tr>
                                                                                    @endforeach
    ...
    isset($Details['canaryData'][0]['property/school']['result']['school']))
                                    ...
                                    @endif
                                    {{-- @dd($Details['SchoolDetails']['schools']) --}}
                                    @if(isset($Details['SchoolDetails']['schools']) && count($Details['SchoolDetails']['schools']) > 0)
                                    <div class="aris_school_section" id="schoolData">
                                        ...
                                        <div class="school_innerContent">
                                            <p class="paragraph greatSchool">GreatSchools Summary Rating
                                                @forelse ($Details['SchoolDetails']['schools'] as $key => $school)
                                                    <div class="school_innerwidget widget_items" data-toggle="modal"
                                                        data-target="#exampleschoolModal{{ $key }}"
                                                        data-universal-id="{{ $school['universal-id'] }}"
                                                        data-school-id="{{ isset($school['id']) ? $school['id'] : '' }}">


                                                        <div class="school_innerwidget_left">
                                                            <p class="para"><strong
                                                                    class="school_rating">{{ isset($school['rating']) ? $school['rating'] : '-' }}</strong>/10
                                                            </p>
                                                        </div>
                                                        <div class="school_innerwidget_right">
                                                            <ul>
                                                                <li>
                                                                    <p class="school_name school_rating">
                                                                        {{ $school['name'] }}</p>
                                                                    @php
                                                                    ...
                                                                    <small>{{ $school['type'] . ', ' . $firstLevel . '-' . $lastLevel }}
                                                                        • Serves this home •
                                                                        {{ formatDistance($school['distance']) }}</small>
                                                                </li>
                                                                <li>
                                                ...
                                                @empty
                                                @endforelse
                                                <small class="disclaimer_text mt-2">School data is provided by
                                                    GreatSchools, a nonprofit organization. ARIS360 recommends buyers and
                                                    renters use GreatSchools information and ratings as a first step, and
                                                    conduct their own investigation to determine their desired schools or
                                                    school districts, including by contacting and visiting the schools
                                                    themselves.</small>
                                                <small class="disclaimer_text">ARIS360 does not endorse or guarantee this
                                                    information. School service boundaries are intended to be used as a
                                                    reference only; they may change and are not guaranteed to be accurate.
                                                    To verify school enrollment eligibility, contact the school district
                                                    directly.</small>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="advertise_banner">
                                        <img src="{{ asset('public/assets/images/Lease-Banner.png') }}" alt="">
                                    </div>
                       ...
                       @include('properties.includes.Schedule-tour')
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-lg-3 col-md-3 col-sm-6">
                                                        <div class="arisestimate_content_list">
                                                            ...
                                                            <p>${{ number_format($Details['canaryData'][0]['property/value']['result']['value']['price_upr']) }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-lg-3 col-md-3 col-sm-6">
                                                        <div class="arisestimate_content_list">
                                                            ...
                                                            <p>${{ number_format($Details['canaryData'][0]['property/value']['result']['value']['price_mean']) }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-lg-3 col-md-3 col-sm-6">
                                                        <div class="arisestimate_content_list">
                                                            ...
                                                            <p>${{ number_format($Details['canaryData'][0]['property/value']['result']['value']['price_lwr']) }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-lg-3 col-md-3 col-sm-6">
                                                        <div class="arisestimate_content_list">
                                                            ...
                                                            <p>{{ confidenceScore($Details['canaryData'][0]['property/value']['result']['value']['fsd']) }}%
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="aris_estimate_sec_content">
                                                <div class="row">
                                                    <div class="col-12 col-lg-3 col-md-3 col-sm-6">
                                                        <div class="arisestimate_content_list">
                                                            <small>Upper Value</small>
                                                            <p>${{ number_format($Details['canaryData'][0]['property/rental_value']['result']['price_upr']) }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-lg-3 col-md-3 col-sm-6">
                                                        <div class="arisestimate_content_list">
                                                            <small>Average Value</small>
                                                            <p>${{ number_format($Details['canaryData'][0]['property/rental_value']['result']['price_mean']) }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-lg-3 col-md-3 col-sm-6">
                                                        <div class="arisestimate_content_list">
                                                            <small>Lower Value</small>
                                                            <p>${{ number_format($Details['canaryData'][0]['property/rental_value']['result']['price_lwr']) }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-lg-3 col-md-3 col-sm-6">
                                                        <div class="arisestimate_content_list">
                                                            <small>Confidence score</small>
                                                            <p>{{ confidenceScore($Details['canaryData'][0]['property/rental_value']['result']['fsd']) }}%
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            {{-- @if (// isset($Details['canaryData']) && isset($Details['canaryData'][0]['property/value']) &&
    // isset($Details['canaryData'][0]['property/value']['result']) &&
    // isset($Details['canaryData'][0]['property/value']['result']['value'])
    isset($Details['canaryData'][0]['property/value']['result']['value'])) --}}
                            @if ($Details['properties']->PublishStatus == 'Active')
                                <div class="col-lg-4 col-md-4 col-12">
                                        ...
                                        <div class="schedule_meeting_section">
                                            ...
                                            <div class="calendarCont">
                                                ...
                                                <div class="btn-box">
                                                    ...
                                                    @if (!empty($Details['agent_details']))
                                                        <input type="hidden"
                                                            value="{{ $Details['agent_details'][0]['email'] }}"
                                                            id="emailID">
                                                        <input type="hidden"
                                                            value="{{ $Details['agent_details'][0]['id'] }}"
                                                            id="agentID">
                                                        <input type="hidden"
                                                            value="{{ ucfirst($Details['agent_details'][0]['first_name']) . ' ' . ucfirst($Details['agent_details'][0]['last_name']) }}"
                                                            id="agentUserName">
                                                    @else
                                                        ...
                                                        <input type="hidden" value="" id="agentUserName">
                                                    @endif
                                                    <a href="javascript:void(0)" class="theme-btn btn-one schedule_now"
                                                        id="schedule_now">Schedule Now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
                        ...
                        <div class="author-widget sidebar-widget">
                            <div class="feature-block">
                                <div class="feature-block-one feature_block_two">
                                    <h3 class="mb-3">Recently Listed Properties
                                        {{ isset($Details['properties']->CityName) ? 'In ' . $Details['properties']->CityName . ',' : '' }}
                                        {{ isset($Details['properties']->PostalCode) ? $Details['properties']->PostalCode : '' }}
                                    </h3>
                                        ...
                                        @foreach ($Details['PropertyListed'] as $property)
                                            <div class="inner-box propertyDetail-innerbox">
                                                <div class="image-box">
                                                    ...
                                                    @endif
                                                    @if ($property['PublishStatus'] == 'Sold' || $property['PublishStatus'] == 'Closed')
                                                        <span class="category2">Sold</span>
                                                    @else
                                                        {{-- <span class="category">Active</span> --}}
        ...
        @if(!empty($Details['recentlyViewedProperties']))
            <div class="similar-content Similar_Properties">
                <div class="title">
                    <h3>Recently Viewed Properties
                        {{ isset($Details['properties']->CityName) ? 'In ' . $Details['properties']->CityName . ',' : '' }}
                        {{ isset($Details['properties']->PostalCode) ? $Details['properties']->PostalCode : '' }}
                    </h3>
                </div>
                <div class="row clearfix">
                    @foreach ($Details['recentlyViewedProperties'] as $property)
                        <div class="col-12 col-lg-4 col-md-4 col-sm-6 feature-block">
                            <div class="feature-block-one feature_block_two">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <a href="{{ route('home.property-detail', ['id' => $property['property']['id']]) }}">
                                            @if (isset($property['property']['preffered_media']) && count($property['property']['preffered_media']) > 0)
                                                <figure class="image">
                                                    <img class="lazy"
                                                        src="{{ $property['property']['preffered_media'][0]['s3buckettempurl'] }}"
                                                        alt="">
                                                </figure>
                                            @endif
                                        </a>
                                        @if ($property['property']['PropetySellPrice'] > 1000000)
                                            {{-- <span class="category">Active</span> --}}
                                            <span class="category"> ARIS360 Premier</span>
                                        @endif
                                        @if ($property['property']['PublishStatus'] == 'Sold' || $property['property']['PublishStatus'] == 'Closed')
                                            <span class="category2">Sold</span>
                                        @else
                                            {{-- <span class="category">Active</span> --}}
                                            <span class="category2">{{ $property['property']['PublishStatus'] }}</span>
                                        @endif
                                    </div>

                                    <div class="lower-content lower_content_Detail">
                                        <div class="price-info custom_price_info">
                                            <h4 class="mt-2">$ {{ number_format($property['property']['PropetySellPrice']) }}</h4>
                                            ...
                                            <div class="fav_and_share">
                                                <div class="share_onlyIcon">
                                                    <ul class="other-option feat_fav pull-right clearfix">
                                                        @if (auth()->check())
                                                            <li>
                                                                <button id="shrBtnListed{{ $property['property']['id'] }}"
                                                                    data-id="{{ $property['property']['id'] }}"
                                                                    data-text="{{ $property['property']['id'] }}"
                                                                    data-user="{{ Auth::id() }}" href="javascript:;"
                                                                    data-toggle="modal" data-target="#shareModal"
                                                                    class="formShare">
                                                                    <i class="far fa-share"></i>
                                                ...
                                                <div class="fav_onlyIcon">
                                                    @if (auth()->check())
                                                        @if (isset($property['property']['favorite_property'][0]['is_fav']) and $property['property']['favorite_property'][0]['is_fav'] == 1)
                                                            <ul class="other-option feat_fav pull-right clearfix">
                                                                <li>
                                                                    <button id="favBtnListed{{ $property['property']['id'] }}"
                                                                        data-id="{{ $property['property']['id'] }}"
                                                                        data-text="{{ $property['property']['id'] }}"
                                                                        class="formFavourite skzfavx"><i
                                                                            class="fas fa-heart"></i></button>
                                        ...
                                        <ul class="more-details mt-2 clearfix">
                                            <li> {{ $property['property']['Bedrooms'] }} Beds</li>
                                            <li> {{ $property['property']['BathroomsFull'] }} Baths</li>
                                            <li> {{ $property['property']['PropertyArea'] }} sq. ft</li>
                                        ...
                                        <div class="title-text">
                                            <h5><a href="#">{{ $property['property']['PropertyAddress'] }}</a></h5>
                                        </div>
                                        <div class="listing_key_section">
                                            <ul>
                                                <li>
                                                ...
                                                <li>
                                                    @if ($property['property']['PropetySellPrice'] > 1000000)
                                                        <p> Premier Properties </p>
                                                    @else
                                                        <p> {{ isset($property['property']['structure_type'][0]['StructureTypeName'])
                                                            ? $property['property']['structure_type'][0]['StructureTypeName']
                                                            : ' N/A ' }}
                                                        </p>
                                                    @endif
                                                </li>
        ...
        @endif
            <div class="disclaimer_section">
                <p>Listing provided by NWMLS <img class="lazy" src="{{ asset('public/assets/images/NWMLS2.jpeg') }}"
                        class="img-fluid"></p>
    ...
    <!-- Modal -->
    <div class="modal fade" id="propertyDetailimg" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                @foreach ($Details['propertyMedia'] as $key => $property)
                                    <a class="nav-link {{ $key == 0 ? 'active' : '' }}"
                                        id="v-pills-propertyimgtab1-tab" data-toggle="pill"
                                ...
                                @foreach ($Details['propertyMedia'] as $key => $property)
                                    <div class="tab-pane fade show {{ $key == 0 ? 'active' : '' }}"
                                        ...
                                        <div class="property_inner_detail_images">
                                            <img id="" class="lazy"
                                                src="{{ $property['s3buckettempurl'] }}" alt="">
                                        </div>
                                        <div class="author-info clearfix">
                                            <ul class="rating text-center mt-3 clearfix">
                                                <a class="theme-btn btn-one js-anchor-link"
                                                    href="#schedule-tour">Schedule
                                                    Tour</a>
                                            </ul>
                                        </div>
    ...
    @if(isset($Details['SchoolDetails']['schools']) && count($Details['SchoolDetails']['schools']) > 0)
        @forelse ($Details['SchoolDetails']['schools'] as $key => $school)
            <div class="modal fade propertyDetail_schoolModal" id="exampleschoolModal{{ $key }}"
                        ...
                        <div class="modal-body">
                            <div class="propertyDetail_schoolModal_wrapper">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="summary-rating-and-reviews">
                                            <div class="summary-rating-detail">
                                                <p class="para">
                                                    <strong>{{ isset($school['rating']) ? $school['rating'] : '-' }}</strong>/10
                                                </p>
                                        ...
                                        <div class="other_service_summary">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <p>{{ $school['street'] . ', ' . $school['city'] . ', ' . $school['state'] . ' ' . $school['zip'] }}
                                                    </p>
                                                </li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <h3><a class="collapse_header_title" href="javascript:void(0)">GreatSchools
                                                Subrating</a></h3>
                                        <div id="collapse-col-{{ $school['universal-id'] }}" class="collapse_wrap">
                                    ...
                                    <div class="selector">
                                        ...
                                        <div class="selecotr-item">
                                            <input type="radio" id="radio3" name="selector"
                                                class="selector-item_radio">
                                            <label for="radio3" class="selector-item_label">Food & Drink
                                                <span>65</span></label>
                                        </div>
                                        <div class="selecotr-item">
                                            <input type="radio" id="radio4" name="selector"
                                                class="selector-item_radio">
                                            <label for="radio4" class="selector-item_label">Park
                                                <span>8</span></label>
                                        </div>
                                        <div class="selecotr-item">
                                            <input type="radio" id="radio5" name="selector"
                                                class="selector-item_radio">
                                            <label for="radio5" class="selector-item_label">Shopping
                                                <span>8</span></label>
                                        </div>
                                        <div class="selecotr-item">
                                            <input type="radio" id="radio6" name="selector"
                                                class="selector-item_radio">
                                            <label for="radio6" class="selector-item_label">Sports and Recreation
                                                <span>24</span></label>
                                        </div>
                                        <div class="selecotr-item">
                                            <input type="radio" id="radio7" name="selector"
                                                class="selector-item_radio">
                                            <label for="radio7" class="selector-item_label">Entertainment
                                                <span>12</span></label>
                                        </div>
                                        <div class="selecotr-item">
                                            <input type="radio" id="radio8" name="selector"
                                                class="selector-item_radio">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                ...
                                                                <ul class="transit_numBox_wrapper">
                                                                    <li>
                                                                        <a href="javascript:void(0)"><span
                                                                                class="transit_numBox">South Lake Union
                                                                                Streetcar</span></a>
                                                                    </li>
                                                                </ul>
                                                            </li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="Climate_risks_modalwrapper around_thishome_modalwrapper">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-Flood-tab" data-toggle="pill"
                                    href="#pills-Flood" role="tab" aria-controls="pills-Flood"
                                    aria-selected="true">Flood</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-Fire-tab" data-toggle="pill" href="#pills-Fire"
                                    role="tab" aria-controls="pills-Fire" aria-selected="false">Fire</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-Heat-tab" data-toggle="pill" href="#pills-Heat"
                                    role="tab" aria-controls="pills-Heat" aria-selected="false">Heat</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-Flood" role="tabpanel"
                                ...
                                <div class="climate_risk_sect_content">
                                    <div class="climate_risk_sect_content_1">
                                        ...
                                        <span>
                                            <img class="lazy"
                                                src="{{ asset('public/assets/images/flood_minimal_img.png') }}"
                                                alt="">
                                        </span>
                            ...
                            <div class="tab-pane fade" id="pills-Fire" role="tabpanel"
                                aria-labelledby="pills-Fire-tab">
                                <div class="climate_risk_sect_content">
                                    <div class="climate_risk_sect_content_1">
                                        ...
                                        <h5>Fire Factor</h5>
                                        <span>
                                            <img src="{{ asset('public/assets/images/fire-factor-score-01.png') }}"
                                                alt="">
                                        </span>
                            ...
                            <div class="tab-pane fade" id="pills-Heat" role="tabpanel"
                                aria-labelledby="pills-Heat-tab">
                                <div class="climate_risk_sect_content">
                                    <div class="climate_risk_sect_content_1">
                                        ...
                                        <h5>Heat Factor</h5>
                                        <span>
                                            <img src="{{ asset('public/assets/images/heat-factor-score-03.png') }}"
                                                alt="">
                                        </span>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="Climate_risks_modalwrapper around_thishome_modalwrapper">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-storm-tab" data-toggle="pill"
                                    href="#pills-storm" role="tab" aria-controls="pills-storm"
                                    aria-selected="true">Storm</a>
                            </li>
                            <li class="nav-item">
    ...
    <script>
        ...
        // Attach a click event handler to the modal
        $('.widget_items').on('click', function() {
            var universalId = $(this).data('universal-id');
            var schoolId = $(this).data('id'); // Retrieve the school ID from data attribute
            let wrapper = document.getElementsByClassName('collapse_wrap');
            for (item of wrapper) {
                item.innerHTML = '';
            }

            document.getElementById(`collapse-col-${universalId}`).innerHTML = '<div class=" loading_row skeleton"></div>'



            $.ajax({
                url: "<?php echo url('/schoolsubrating'); ?>",
                method: 'GET',
                dataType: 'json',
                data: {
                    universalId: universalId,
                    schoolId: schoolId
                }, // Send the school ID as data
                success: function(response) {
                    // Handle the response from your controller
                    var subratingData = response[0]?.sub_rating;
                    console.log(subratingData, "subratingData")
                    var subratingElement
                    document.getElementById(`collapse-col-${universalId}`).innerHTML = ''

                    console.log(subratingElement)

                    for (data of Object.keys(subratingData)) {

                        let _id = `${data}-${universalId}`;

                        subratingElement = `
                                    <div class="collapse_items">
                                    <h1>${subratingData[data]?.value} / 10</h1>
                                    <div id='${_id}'
                                        class="custom_collapse">
                                        <button onclick="onOpenCollapse('${_id}')"><span>${data.split('-').join(' ')} </span>
                                            <i id="${_id}-arrow" class="fa fa-angle-down"></i>
                                        </button>
                                        <div id="${_id}-content"
                                            class="collapse_content">
                                            <p>
                                                ${subratingData[data]?.description}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                `
                        document.getElementById(`collapse-col-${universalId}`).innerHTML += subratingElement;
                    }
                },
                error: function() {
