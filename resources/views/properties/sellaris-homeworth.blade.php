        ...
        <div class="container-fluid">
            ...
            <div class="tabs-box">
                ...
                <ul class="tab-btns tab-buttons clearfix">
                    ...
                    <li class="list_tab2 tab-btn" data-tab="#tab-2"><span>2</span>Selling Plan</li>
                            ...
                            <div class="inner-box default-form">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-12 column mb-2 text-center">
                                        ...
                                        <a href="{{ route('sell-with-aris') }}" class="theme-btn btn-one">Edit Address</a>
                    ...
                    <form action="{{ route('store_property_lead') }}" method="POST">
                        ...
                        <div class="tab" id="tab-2">
                            ...
                            <div class="property-details">
                                ...
                                <input type="hidden" name="address" value="{{ $address }}" required id="autocomplete">
                                ...
                                <div class="inner-box default-form">
                                    ...
                                    <div class="row clearfix">
                                                    ...
                                                    <select class="wide" name="property_type" required>
                                                        ...
                                                        @if (isset($propertyTypes) && count($propertyTypes) > 0)
                                                            @foreach ($propertyTypes as $value)
                                                                <option value="{{ $value->StructureTypeName }}">
                                        ...
                                        <div class="col-lg-12 column mt-4">
                                            ...
                                            <div class="selector d-flex justify-content-between">
                                                ...
                                                <div class="selecotr-item">
                                                    ...
                                                    <input type="radio" id="radio7" name="plan_to_sell_home"
                                                        value="Immediately" class="selector-item_radio" checked>
                                                ...
                                                <div class="selecotr-item">
                                                    ...
                                                    <input type="radio" id="radio3" name="plan_to_sell_home"
                                                        value="Next 3 Months" class="selector-item_radio">

                                                    <label for="radio3" class="selector-item_label">Next 3
                                                        Months</label>
                                                ...
                                                <div class="selecotr-item">
                                                    ...
                                                    <input type="radio" id="radio4" name="plan_to_sell_home"
                                                        value="Next 3-6 Months" class="selector-item_radio">

                                                    <label for="radio4" class="selector-item_label">Next 3-6
                                                        Months</label>
                                                ...
                                                <div class="selecotr-item">
                                                    ...
                                                    <input type="radio" id="radio5" name="plan_to_sell_home"
                                                        value="Next 6-12 Months" class="selector-item_radio">

                                                    <label for="radio5" class="selector-item_label">Next 6-12
                                                        Months</label>
                                                ...
                                                <div class="selecotr-item">
                                                    ...
                                                    <input type="radio" id="radio6" name="plan_to_sell_home"
                                                        value="Next 12+ Months" class="selector-item_radio">

                                                    <label for="radio6" class="selector-item_label">Next 12+
                                                        Months</label>
                                        ...
                                        <div class="col-lg-12 column">
                                            ...
                                            <h5>Have You Signed An Agreement With An Agent To Help You Sell Your Home ?
                                            </h5>
                                        ...
                                        <div class="col-lg-12 column mt-4 mb-4">
                                            ...
                                            <div class="selector d-flex justify-content-start">
                                                ...
                                                <div class="selecotr-item">
                                                    ...
                                                    <input type="radio" id="radioaa" name="any_agent" value="Yes"
                                                ...
                                                <div class="selecotr-item">
                                                    ...
                                                    <input type="radio" id="radiobb" name="any_agent" value="No"
