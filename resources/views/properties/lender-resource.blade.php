@php
    $metaTitle = 'Lender Resource Near Washington | Lender Resource Washington';
    $metaDescription = "Access a lender resource near Washington. Find a lender resource near you for valuable insights and guidance in the Washington area.";
@endphp
<head>
		...
		<div class="container">
			<div class="blog-grid-content">
				...
				<div class="text-center	my-5">
					<h1 class="text-dark">{!! $page[2]['content'];!!}</h1>
				</div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            <div class="in-blog-item">
                                <div class="blog-title headline">
                                    <h3>
                                        <a href="{{ url('/lender-resource').'/'.$myhbguide['b_slug'] }}" tabindex="0">
                                            {{ $myhbguide['blog_title'] }}
                                        </a>
                                    </h3>
                                </div>
                                <div class="blog-img">
                                    <img class="lazy" data-src="{{ asset('public/images/blogs/'.$myhbguide['blog_cover']) }}" alt="">
                                </div>
                            </div>
                        </div>
                        @endforeach
