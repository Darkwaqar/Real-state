                    ...
                    <div class="search_container for_home" id="search_container">
                        <div class="peroperty_serach_wrapper" id="search_wrapper">
                            ...
                            <div class="input_wrapper position-relative">
                                <input id="search_city_input" name="search_city_input" type="text" autocomplete="off"
                                    onclick="onOpenSearchModal()" placeholder="Enter City or Zip">
                                ...
                                border-radius: 50px;
                                    ...
                                    <span id='search-placeholder-icon'><svg width="15" height="15" fill="none"
                            ...
                            <div class="property_search_modal" id="search_modal">
                                <div class="current_location_box" id="current_location_box" onclick="getCurrentLocation()">
