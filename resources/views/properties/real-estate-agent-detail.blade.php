        ...
        @if (isset($aris360PrimeProperties) && count($aris360PrimeProperties) > 0)
            <div class="container">
                <div class=" py-5">
                    <div class="">
                        <div
                            class="{{isset($aris360PrimeProperties) && count($aris360PrimeProperties) > 2 ? 'three-item-carousel-no-loop' : 'three-item-carousel'}} styled_owl_nav owl-carousel owl-theme owl-dots-none nav-style-one">
