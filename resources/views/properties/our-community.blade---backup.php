    ...
    <section class=" mtts-20">
                ...
                <div class="row item-shorting mt-3">
                    <div class="col property-filter-select">
                        <p class="pgssts">Showing
                            {{ $properties['propertiesCount'] <= 20 ? $properties['propertiesCount'] : 20 }} of
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                function initiliazeAllMapsApi() {
                    myMap()
                    initialize()
                }
                initiliazeAllMapsApi()
            });
            ...
            function initializeMap(properties, type) {
                ...
                markers = locations.map(function(location) {
                    ...
                    marker.addListener("click", function(e) {
                        ...
                        activeMarker = this;
                        var newIcon = '{{ asset('public/assets/images/marker-wide-img_black.png') }}';
                ...
                function getPlaceId(urlParams) {
                    ...
                    function addMarker(lat, lng, price) {
                        ...
                        const newMarker = new google.maps.Marker({
                            ...
                            icon: {
                                url: '{{ asset('public/assets/images/marker-wide-img_black.png') }}',
                                size: new google.maps.Size(60, 28),
                                scaledSize: new google.maps.Size(60, 28),
                            },
                        });
        ...
        function testingSameer(response, skzCategory, page) {
            if (response.count && typeof response.count === 'number' && response.count > 0) {
                if (response.count <= 20) {
                    ...
                    var paginationText = 'Showing ' + 20 + ' of ' + response.count;
                }
            ...
            var perPage = 20; // Number of records to display per page
