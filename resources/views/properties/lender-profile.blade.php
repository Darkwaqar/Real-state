    							...
    							<div class="col-lg-6 col-12 col-md-6  text-left">
    								 <div class="lendl-cardwrap">
    								     <div class="tri-imagewrap">
        								    <img src="public/images/tri-star-home-loans-profile.png" class="img-360 mb-2" alt="">
    								     </div>
    								     <div class="lendl-carddetail">
							            	<h5 class="mb-0 text-left">
                								<span class="tristart-text">Tristar Home Loans</span>
						...
						<div class="in-blog-details-content-area">
							...
							<div class="in-blog-details-text-area about-wrapper headline ul-li-block pera-content">
								<div class="in-blog-details-text-wrap">
									...
									<h3>About Tristar Home Loans</h3>

									<!--<div class="collapse collapse_show_less" id="collapseCompanyDetails">-->
									<div class="about-text-wrap">
											<p>Tristar Home Loans is a national lender for borrowers who want to work with a great lender that goes above and beyond for them!</p>
										<!--<blockquote>-->
								...
								<div class="category-widget ul-li-block">
									...
									<ul>
										<li>
											...
											{{-- https://www.tri-starhomeloans.com/ --}}
											   www.tristarfinance.com
											</a>
										</li>
									</ul>
								</div>
									...
									<li>
										<div class="comment_element">
											...
											<div class="comment_content pera-content mt-2" style="border-bottom: unset !important;">
												<div class="reviews-headwrapper">
												    <h4 class="review-headtext"><a href="#">Home finance</a></h4>
												    <span>12/18/2022</span>
												</div>
												<p class="review-gentext">SreeK from Olympia, WA</p>
												<p>Awesome service, very responsive team. They helped closing my investment property on time. Process was pretty smooth. Wonderful experience working with them. </p>
											</div>
										</div>
									</li>
								 	...
								 	<li>
										<div class="comment_element">
											...
											<div class="comment_content pera-content mt-2" style="border-bottom: unset !important;">
												<div class="reviews-headwrapper">
												    <h4 class="review-headtext"><a href="#">Great and prompt service</a></h4>
												    <span>12/18/2022</span>
												</div>
												<p class="review-gentext">Vimal Patel from Puyallup</p>
												<p>Used them for an investment property purchase. Versatile array of products. Great and prompt service. On time closing. Will definitely use them more for my next purchases as well.</p>
											</div>
										</div>
									</li>
									<!--<li class="text-center mb-3">-->
