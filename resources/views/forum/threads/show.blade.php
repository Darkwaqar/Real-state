                        ...
                        @if ($comment->forum_comment_id === null)
                            <div>
                                <ul class="comments">
                                    <div class="icon d-flex align-items-center">
                                        <div>
                                            @if (!empty($comment['user']['user_dp']))
                                                <img width="50px" class="lazy rounded-circle comments_images"
                                                    data-src="{{ asset('public/images/userdp/' . $comment['user']['user_dp']) }}"
                                                    alt=""
                                    ...
                                    <div class="d-flex ">
                                        <p class="text-secondary fs_14">
                                            {{ isset($comment['user']['first_name']) ? $comment['user']['first_name'] : '' }}
                                        </p>
                                        <p class="time ml-4 text-secondary fs_14">
                                            {{ \Carbon\Carbon::parse($comment->created_at)->format('d F') }}</p>
                                    </div>
                                                ...
                                                <div class="d-flex align-items-center ml-5">
                                                    ...
                                                    <div>
                                                        @if (!empty($reply['user']['user_dp']))
                                                            <img width="50px" class="lazy rounded-circle comments_images"
                                                                data-src="{{ asset('public/images/userdp/' . $reply['user']['user_dp']) }}"
                                                                alt=""
                                                                src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==">
                                                        @else
                                                            <img width="50px" class="lazy rounded-circle comments_images"
                                                                data-src="{{ asset('public/images/userdp/profile.jpg') }}"
                                                                alt=""
                                                                src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==">
                                                        @endif
                                                    </div>
