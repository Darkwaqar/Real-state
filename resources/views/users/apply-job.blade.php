...
@section('content')
    ...
    <section class="agentInfo-wrapper myprofile-section sec-pad" id="scrollToApplyForm">
        <div class="container-fluid">
            <div class="tabs-box">
                ...
                <form action="{{ url('/new-user') }}" method="POST" enctype="multipart/form-data" id="agentForm">
                    @csrf
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 column">
                                            <div class="field-input">
                                                ...
                                                <div class="select-box">
                                                    <select class="wide" name="agentType">
                                                        <option value="aris">
                                                            Aris360 Agent
                                                        </option>
    ...
    @enderror-->
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 column">
                                            <div class="field-input">
                                                <label>Identity (Passport/ID Card/ Driving Licence) </label>
                                        ...
                                        <div class="col-lg-12 column">
                                            <div class="field-input">
                                                <label>Within the last 10 years, have you had any action (such as a fine,
                                                    ...
                                                    license or any other professional license? </label>
                                                <div class="select-box">
                                        ...
                                        <div class="col-lg-12 column">
                                            <div class="field-input">
                                                <label>Have you ever been disciplined by any local board of Realtors, local
                                                    ...
                                                    real estate association or governing body? </label>
                                                <div class="select-box">
                                        ...
                                        <div class="col-lg-12 column">
                                            <div class="field-input">
                                                <label>Are you currently under investigation or is there a pending charge
                                                    against you involving your real estate license? </label>
                                                <div class="select-box">
                                        ...
                                        <div class="col-lg-12 column">
                                            <div class="field-input">
                                                <label>Do you currently hold an active and unrestricted real estate license?
                                                    (Please note: An active real estate license is for this role.) </label>
                                                <div class="select-box">
                        ...
                        {{-- <div class="tab" id="tab-6">
                            <div class="review-content-wrapper">
                                ...
                                <div class="review-inner-box">
                                    ...
                                    <p class="pt-4"><strong>Do you currently hold an active and unrestricted real estate license? (Please note: An active real estate license is  for this role.)</strong></p>
                                    <p>No</p>
    ...
    <script>
        ...
        function initAutocomplete() {
            autocomplete = new google.maps.places.Autocomplete(
                (document.getElementById('agentAddress')), {
                    types: ['geocode']
                });
