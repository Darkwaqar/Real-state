...
@section('content')
                    ...
                    <div class="admin-tab-wrapp">
                                ...
                                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="pills-dashboard-tab" data-toggle="pill"
                                            href="#pills-dashboard" type="button" role="tab"
                                            aria-controls="pills-dashboard" aria-selected="true" data-tab="tab1">Dashboard</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-lead-tab" data-toggle="pill" href="#pills-lead"
                                            type="button" role="tab" aria-controls="pills-lead" aria-selected="false" data-tab="tab2">
                                            Featured Leads
                                        </button>
                                    ...
                                    @if (isAgentFeatured())
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-myresponse-tab" data-toggle="pill"
                                                href="#pills-myresponse" type="button" role="tab"
                                                aria-controls="pills-myresponse" aria-selected="false" data-tab="tab3">
                                                My Leads
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-wallet-tab" data-toggle="pill"
                                                href="#pills-wallet" type="button" role="tab" aria-controls="pills-wallet"
                                                aria-selected="false" data-tab="tab4">
                                                Wallet
                                            </button>
                                        </li>
                                    @endif
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-notification-tab" data-toggle="pill"
                                            href="#pills-notification" type="button" role="tab"
                                            aria-controls="pills-notification" aria-selected="true" data-tab="tab5">Inquiries</button>
                                    </li>

                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-save-tab" data-toggle="pill" href="#pills-save"
                                            type="button" role="tab" aria-controls="pills-save" aria-selected="false" data-tab="tab6">Save
                                            Searches</button>
                                    </li>

                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-setting-tab" data-toggle="pill" href="#pills-setting"
                                            type="button" role="tab" aria-controls="pills-setting" aria-selected="false" data-tab="tab7">My
                                            Listings</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" href="https://www.canva.com/en_gb/login/" target="_blank">Design
                                        </a>
                                    </li>

                                    {{-- <li class="nav-item" role="presentation">
                                        <a class="nav-link"  href="https://app.hubspot.com/login?hubs_signup-url=www.hubspot.com/homepage&hubs_signup-cta=homepage-nav-login&hubs_content=www.hubspot.com/homepage&hubs_content-cta=homepage-nav-login"
                                            type="button" role="tab" aria-controls="pills-setting" aria-selected="false">HubSpot</a>
                                    </li> --}}
                                    {{-- <li class="nav-item" role="presentation">
                        ...
                        <div class="user-inner-content-wrapp">
                            <div class="tab-content mt-3" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-dashboard" role="tabpanel"
                                    ...
                                    <div class="container">
                                        <div class="user-inner-content-title">
                                            <h1>Hey {{ Auth::user()->first_name }}</h1>
                                        </div>
                                        <div class="user-inner-content">
                                            <div class="user-leftSect">
                                                ...
                                                <h5 class="prof_title">Need Help?</h5>
                                                <div class="prof-setting">
                                                    <!--<p class="paragraph">visit <a href="javascript:void(0)">help center</a> for tips &amp; advice</p>-->
                                                    <p><a href="emailto:infot@aris360.com" class="paragraph">Email:
                                                            info@aris360.com</a></p>
                                                    <p><a href="tel:(833) 966-1976" class="paragraph">Call: (833) 966-1976</a>
                                                    </p>
                                            ...
                                            <div class="user-rightSect">
                                                <div class="row">
                                                    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                                        <div class="ff_one ">
                                                            <div class="detais">
                                                                <div class="timer">{{ $myLeads }}</div>
                                                                <p>Leads</p>
                                                            </div>
                                                            <div class="icon">
                                                                <span class="flaticon-home">
                                                                    <img src="{{ asset('public/assets/images/negotiation.png') }}"
                                                                        class="img-fluid">
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @if (getUserSessionData('type') == 'featured')
                                                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                                    ...
                                                    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                                        <div class="ff_one style3">
                                                            <div class="detais">
                                                                <div class="timer">{{ $myProperties }}</div>
                                                                <p>My Properties</p>
                                                            </div>
                                                            <div class="icon">
                                                    ...
                                                    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                                        <div class="ff_one style4">
                                                            <div class="detais">
                                                                <div class="timer">{{ $myPendingProperties }}</div>
                                ...
                                <div class="tab-pane fade" id="pills-myresponse" role="tabpanel"
                                    aria-labelledby="pills-myresponse-tab">
                                    <div class="container">
                                        <div class="user-inner-content-title">
                                            <h1>My Leads</h1>
                                        </div>
                                        <div class="lead-inner-content">
                                            <div class="lead-leftSect">
                                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                                    ...
                                                    @forelse($myPropertyLeads as $key => $MyPropertyLead)
                                                        <a class="nav-link {{ $key == 0 ? 'active' : '' }}"
                                                            id="v-pills-home-tab" data-toggle="pill"
                                                            href="#myleads-v-pills-{{ $key }}"
                                                            data-lead="{{ $MyPropertyLead->id }}" role="tab"
                                                            aria-controls="v-pills-home" aria-selected="true">
                                                            <h5 class="prof_title">
                                                                {{ isset($MyPropertyLead->Lead->name) ? $MyPropertyLead->Lead->name : 'N/A' }}
                                                                <small>{{ \Carbon\Carbon::parse($MyPropertyLead->created_at)->toFormattedDateString() }}</small>
                                                            </h5>
                                                            <p class="text_modal_btn"><span><i
                                                                        class="fas fa-map-marker-alt"></i>{{ isset($MyPropertyLead->Lead->name) ? $MyPropertyLead->Lead->city : 'N/A' }}</span>
                                                            </p>
                                                            {{-- <p class="text_modal_btn"><span><i class="fas fa-coins"></i> 75
                                                                    Aris credits</span></p> --}}
                                                        </a>
                                                    @empty
                                                    @endforelse
                                                ...
                                                <div class="tab-content" id="v-pills-tabContent">
                                                    @forelse($myPropertyLeads as $key => $MyPropertyLead)
                                                        <div class="tab-pane fade show {{ $key == 0 ? 'active' : '' }}"
                                                            id="myleads-v-pills-{{ $key }}" role="tabpanel"
                                                            aria-labelledby="myleads-v-pills-{{ $key }}">
                                                            <div class="lead_right_innercontent">
                                                                <ul class="feature_lead_list mt-2">
                                                                    <li>
                                                                        <a href="javascript:void(0)">
                                                                            <span><i class="fas fa-user"></i></span>
                                                                            <p>
                                                                                <span>Name:</span>
                                                                                <span>{{ isset($MyPropertyLead->Lead->name) ? $MyPropertyLead->Lead->name : 'N/A' }}</span>
                                                                            </p>
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0)">
                                                                            ...
                                                                            <p>
                                                                                <span>Email:</span>
                                                                                <span>
                                                                                    {{ isset($MyPropertyLead->Lead->name) ? $MyPropertyLead->Lead->email : 'N/A' }}</span>
                                                                            </p>
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0)">
                                                                            ...
                                                                            <p>
                                                                                <span>Contact:</span>
                                                                                <span>
                                                                                    {{ isset($MyPropertyLead->Lead->name) ? $MyPropertyLead->Lead->contact : 'N/A' }}
                                                                                </span>
                                                                            </p>
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0)">
                                                                            ...
                                                                            <p>
                                                                                <span>City:</span>
                                                                                <span>
                                                                                    {{ isset($MyPropertyLead->Lead->name) ? $MyPropertyLead->Lead->city : 'N/A' }}</span>
                                                                            </p>
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0)">
                                                                            ...
                                                                            <p>
                                                                                <span>State:</span>
                                                                                <span>
                                                                                    {{ isset($MyPropertyLead->Lead->name) ? $MyPropertyLead->Lead->state : 'N/A' }}
                                                                                </span>
                                                                            </p>
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0)">
                                                                            <span><img
                                                                                    src="{{ asset('public/assets/images/buyer-seller.png') }}">
                                                                            </span>
                                                                            <p>
                                                                                <span>Lead Type:</span>
                                                                                <span>{{ isset($MyPropertyLead->Lead->name) ? $MyPropertyLead->Lead->lead_type : 'N/A' }}
                                                                                </span>
                                                                            </p>
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0)">
                                                                            ...
                                                                            <p>
                                                                                ...
                                                                                <span>
                                                                                    {{ isset($MyPropertyLead->Lead->name) ? $MyPropertyLead->Lead->property_type : 'N/A' }}
                                                                                </span>
                                                                            </p>
                                                                        </a>
                                                                    </li>
                                                                ...
                                                                <div class="mapouter">
                                                                    <div class="gmap_canvas"><iframe width="600"
                                                                            ...
                                                                            src="https://maps.google.com/maps?q={{ isset($MyPropertyLead->Lead->name) ? $MyPropertyLead->Lead->address : 'N/A' }}&t=&z=13&ie=UTF8&iwloc=&output=embed"
                                                                            frameborder="0" scrolling="no" marginheight="0"
                                                                            marginwidth="0"></iframe><a
                                                                            href="https://123movies-i.net">escape room 2
                                                                            123movies</a><br>
                                                                        <style>
                                                                            .mapouter {
                                                                                position: relative;
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="lead-inner-content">
                                            <div class="lead-leftSect">
                                                ...
                                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                                    aria-orientation="vertical">
                                                    @forelse($propertyLeads as $key => $propertyLead)
                                                        @if (isset($propertyLead['lead_purchased']) &&
                                                                $propertyLead['lead_purchased']['lead_id'] == $propertyLead['id'] &&
                                                                $propertyLead['lead_purchased']['agent_id'] == getUserId())
                                                        @else
                                                            <a class="nav-link {{ $key == 0 ? 'active' : '' }}"
                                                                id="v-pills-home-tab" data-toggle="pill"
                                                                href="#v-pills-{{ $key }}"
                                                                data-lead="{{ $propertyLead->id }}" role="tab"
                                                                aria-controls="v-pills-home" aria-selected="true">
                                                                <h5 class="prof_title">{{ $propertyLead->name }}
                                                                    <small>{{ \Carbon\Carbon::parse($propertyLead->created_at)->toFormattedDateString() }}</small>
                                                                </h5>
                                                                <p class="text_modal_btn"><span><i
                                                                            class="fas fa-map-marker-alt"></i>
                                                                        {{ $propertyLead->city }}</span></p>
                                                                {{-- <p class="text_modal_btn"><span><i class="fas fa-coins"></i>
                                                                        75
                                                                        Aris credits</span></p> --}}
                                                            </a>
                                                        @endif
                                              ...
                                              <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical"> --}}
                                                    @forelse($scheduleLeads as $key => $propertyLead)
                                                        @if (isset($propertyLead['lead_purchased']) &&
                                                                $propertyLead['lead_purchased']['lead_id'] == $propertyLead['id'] &&
                                                                $propertyLead['lead_purchased']['agent_id'] == getUserId())
                                                        @else
                                                            <a class="nav-link" id="v-pills-home-tab" data-toggle="pill"
                                                                href="#v-pills-{{ $propertyLead->id * 3 }}"
                                                                data-lead="{{ $propertyLead->id * 3 }}" role="tab"
                                                                aria-controls="v-pills-home" aria-selected="true">
                                                                <h5 class="prof_title">{{ $propertyLead->name }}
                                                                    <small>{{ \Carbon\Carbon::parse($propertyLead->created_at)->toFormattedDateString() }}</small>
                                                                </h5>
                                                                <p class="text_modal_btn"><span><i
                                                                            class="fas fa-map-marker-alt"></i>
                                                                        @if (isset($propertyLead['propertyTour'][0]['CityName']))
                                                                            {{ $propertyLead['propertyTour'][0]['CityName'] }}
                                                                    </span></p>
                                                            @else
                                                                <p> Not known </p>
                                                        @endif
                                                        </span></p>
                                                        {{-- <p class="text_modal_btn"><span><i class="fas fa-coins"></i> 75 Aris
                                                                Credits</span></p> --}}
                                                        </a>
                                                    @endif
                                                    {{-- @endif --}}
                                            ...
                                            <div class="lead-rightSect">
                                                            ...
                                                            <div class="lead_right_innercontent">
                                                                <ul class="feature_lead_list mt-2">
                                                                    ...
                                                                    <li>
                                                                        <a href="javascript:void(0)">
                                                                            ...
                                                                            <p>
                                                                                <span>Email:</span>
                                                                                @if (isAgentFeatured())
                                                                                    <span>{{ \Illuminate\Support\Str::mask($propertyLead->email, '*', 0, 30) }}</span>
                                                                                @else
                                                                                    <span>{{ $propertyLead->email }}</span>
                                                                                @endif
                                                                            </p>
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0)">
                                                                            ...
                                                                            <p>
                                                                                <span>Contact:</span>
                                                                                @if (isAgentFeatured())
                                                                                    <span>{{ \Illuminate\Support\Str::mask($propertyLead->contact, '*', 0, 30) }}</span>
                                                                                @else
                                                                                    <span>{{ $propertyLead->contact }}</span>
                                                                                @endif
                                                                            </p>
                                                                        </a>
                                                                    </li>
                                                                    ...
                                                                    <li>
                                                                        <a href="javascript:void(0)">
                                                                            <span><img
                                                                                    src="{{ asset('public/assets/images/buyer-seller.png') }}"></span>
                                                                            <p>
                                                                                <span>Lead Types:</span>
                                                                                <span>{{ $propertyLead->lead_type }}</span>
                                                                            </p>
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0)">
                                                                            ...
                                                                            <p>
                                                                                <span>Property Type:</span>
                                                                                <span>{{ $propertyLead->property_type }}</span>
                                                                            </p>
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                                <div class="btn-box mb-3">
                                                                    @if (session()->has('user') && Auth::user()->type == 'aris')
                                                                        <form method="POST"
                                                                            action="{{ url('wallet/purchase-lead') }}">
                                                                            @csrf
                                                                            <input type="hidden" name="lead_id"
                                                                                value="{{ $propertyLead->id }}">
                                                                            <button type="submit"
                                                                                class="theme-btn btn-one purchase-lead-btn">Purchase
                                                                                lead</button>
                                                                        </form>
                                                                    @endif
                                                                </div>
                                                                <div class="mapouter">
                                                                    <div class="gmap_canvas"><iframe width="600"
                                                                            height="500" id="gmap_canvas"
                                                                            src="https://maps.google.com/maps?q={{ $propertyLead->address }}&t=&z=13&ie=UTF8&iwloc=&output=embed"
                                                                            frameborder="0" scrolling="no" marginheight="0"
                                                                            marginwidth="0"></iframe><a href="">escape
                                                                            room 2
                                                                            123movies</a><br>
                                                                        <style>
                                                                            .mapouter {
                                                ...
                                                <div class="tab-content mt-5" id="v-pills-tabContent"> --}}
                                                    @forelse($scheduleLeads as $key => $propertyLead)
                                                        <div class="tab-pane fade" id="v-pills-{{ $propertyLead->id * 3 }}"
                                                            role="tabpanel"
                                                            aria-labelledby="v-pills-{{ $propertyLead->id * 3 }}">
                                                            <div class="lead_right_innercontent">
                                                                <ul class="feature_lead_list mt-2">
                                                                    <li>
                                                                        <a href="javascript:void(0)">
                                                                    ...
                                                                    <li>
                                                                        <a href="javascript:void(0)">
                                                                            ...
                                                                            <p>
                                                                                <span>Contact:</span>
                                                                                @if (isAgentFeatured())
                                                                                    <span>{{ \Illuminate\Support\Str::mask($propertyLead->phone, '*', 0, 30) }}</span>
                                                                                @else
                                                                                    <span>{{ $propertyLead->phone }}</span>
                                                                                @endif
                                                                            </p>
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0)">
                                                                            ...
                                                                            <p>
                                                                                @if (isset($propertyLead['propertyTour'][0]['CityName']))
                                                                                    <span>City:</span>
                                                                                    <span>{{ $propertyLead['propertyTour'][0]['CityName'] }}</span>
                                                                                @else
                                                                    ...
                                                                    <li>
                                                                        <a href="javascript:void(0)">
                                                                            <span><i class="fas fa-map-marker-alt"></i></span>
                                                                            <p>
                                                                                @if (isset($propertyLead['propertyTour'][0]['StateOrProvince']))
                                                                                    <span>State:</span>
                                                                                    <span>{{ $propertyLead['propertyTour'][0]['StateOrProvince'] }}</span>
                                                                                @else
                                                                                    <p> Not Data Available</p>
                                                                                @endif
                                                                            </p>
                                                                    ...
                                                                    <li>
                                                                        @if (isset($propertyLead['propertyTour'][0]['id']))
                                                                            <a
                                                                                href="{{ route('home.property-detail', ['id' => $propertyLead['propertyTour'][0]['id']]) }}">
                                                                                <span><i class="fas fa-home"></i></span>
                                                                                <p>
                                                                                    <span>Property Type:</span>
                                                                                    {{ $propertyLead['propertyTour'][0]['PropertyAddress'] }}
                                                                                    <a></span>
                                                                                    @else
                                                                ...
                                                                <div class="mapouter">
                                                                    <div class="gmap_canvas"><iframe width="600"
                                                                            height="500" id="gmap_canvas"
                                                                            src="https://maps.google.com/maps?q= {{ isset($propertyLead['propertyTour'][0]['CityName']) ? $propertyLead['propertyTour'][0]['CityName'] : '' }}&t=&z=13&ie=UTF8&iwloc=&output=embed"
                                                                            frameborder="0" scrolling="no" marginheight="0"
                                                                            marginwidth="0"></iframe><a
                                                                            href="https://123movies-i.net">escape room 2
                                                                            123movies</a><br>
                                ...
                                <div class="tab-pane fade" id="pills-wallet" role="tabpanel"
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="wallet_inner_content">
                                            ...
                                            <div class="ariscredit_section">
                                                <p class="aris_credits">
                                                    1 Aris Credit
                                                </p>
                                                <p><i class="fas fa-equals"></i></p>
                                                <p class="aris_credits">
                                                    $ 2
                                                </p>
                                            </div>
                                            <div class="trans_list">
                                                ...
                                                <table class="table table-bordered mt-5">
                                                    ...
                                                    <tbody>
                                                        @forelse($walletTransactionsHistory as $key => $walletTransactionsHistories)
                                                            <tr>
                                                                <td>{{ $walletTransactionsHistories->card_holder_name }}</td>
                                                                <td>{{ \Carbon\Carbon::parse($walletTransactionsHistories->created_at)->format('d/m/Y') }}
                                                                </td>
                                                                <td>${{ $walletTransactionsHistories->amount }}</td>
                                                                <td>{{ $walletTransactionsHistories->card_number }}</td>
                                                            </tr>
                                                        @empty
                                                            {{-- <p>No Record Found</p> --}}
                                                        @endforelse
                                        ...
                                        <div class="wallet_card_info deposite_section">
                                            <button type="button" class="theme-btn btn-one">+ Make a deposit</button>
                                        </div>
                                        <form class="flip_card_form require-validation"role="form"
                                            action="{{ url('/agent/create-charge') }}" method="post"
                                            data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}"
                                            id="payment-form">
                                            @csrf
                                            <div class="custom_container preload">
                                                        ...
                                                        <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <g id="Front">
                                                                ...
                                                                <text transform="matrix(1 0 0 1 54.1064 428.1723)"
                                                                    id="svgname" class="st2 st5 st6">JOHN DOE</text>
                                            ...
                                            <div class="form-container">
                                                ...
                                                <div class="field-container">
                                                    ...
                                                    <input type="text" id="cardnumber" class="card-number"
                                                        name="card_number">
                                                    {{-- <input id="cardnumber" type="text" pattern="\d*" inputmode="numeric"> --}}
                                                ...
                                                <div class="field-container">
                                                    ...
                                                    <input type="text" id="expirationdate" class="card-expiry-month"
                                                        name="expiry_month" size="2" placeholder="MM" maxlength="2">
                                                    {{-- <input id="expirationdate" type="text" pattern="[0-9]*" inputmode="numeric"> --}}
                                                </div>
                                                <div class="field-container">
                                                    <label for="expirationdate">Expiration year</label>
                                                    <input type="text" id="expirationdate" class="card-expiry-year"
                                                        name="expiry_year" size="4" placeholder="YYYY" maxlength="4">
                                                    {{-- <input id="expirationdate" type="text" pattern="[0-9]*" inputmode="numeric"> --}}
                                                </div>
                                                <div class="field-container">
                                                    <label for="securitycode">Security Code</label>
                                                    <input id="securitycode" type="text" pattern="[0-9]*"
                                                        inputmode="numeric" class="card-cvc" name="cvc">
                                                </div>
                                                <div class="field-container">
                                                    <label for="securitycode">Amount</label>
                                                    <input id="amount" type="number" inputmode="numeric" name="amount">
                                                </div>
                                            ...
                                            <div class="deposite_section">
                                                <button type="submit" class="theme-btn btn-one">Create Deposit</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="pills-notification" role="tabpanel"
                                    ...
                                    <div class="container">
                                                    ...
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th scope="col">What can we help you with?</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @foreach ($userInquiries as $agentInuiry)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $agentInuiry['name'] }}</td>
                                                                    <td>{{ $agentInuiry['email'] }}</td>
                                                                    <td> {{ $agentInuiry['phone'] }}</td>
                                                                    <td>{{ $agentInuiry['city'] }}</td>
                                                                    <td>{{ $agentInuiry['question'] }}</td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
                                                    </table>
                                        ...
                                        <div class="user-inner-content-title">
                                            <h1> Schedule Inquiries Recieved</h1>
                                        </div>
                                        <div class="trans_list">
                                            <!--<p>Inquiries Recieved</p>-->
                                            <div class="main_trans_wrap">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        @if (isset($tour['propertyTour'][0]['id']))
                                                                            <a
                                                                                href="{{ url('property-detail/' . $tour['propertyTour'][0]['id']) }}">
                                                                                {{ $tour['propertyTour'][0]['PropertyAddress'] }}</a>
                                                                        @else
                                                                            <p> N/A </p>
                                                                        @endif
                                                                    </td>
                                                                    <td>{{ stringTodate($agentInuiry['$tour->date']) }}/
                                                                        {{ $tour->time }}</td>
                                                                    <!-- <td colspan="2">
                                                                ...
                                                                <div class="inner-box">
                                                                    <div class="image-box">
                                                                        @if ($usrProperty['PropertyStatus'] == 1)
                                                                            <a
                                                                                ...
                                                                                <figure class="image"><img
                                                                                        src="{{ isset($usrProperty['preffered_media'][0]['id']) ? $usrProperty['preffered_media'][0]['s3buckettempurl'] : '' }}"
                                                                                        alt=""> </figure>
                                                                            </a>
                                                                        @else
                                                                            <figure class="image"><img
                                                                        ...
                                                                        <ul class="close_fav_icon">
                                                                            <li>
                                                                                <button
                                                                                    onclick="confirmDelete('{{ $usrProperty['id'] }}')"
                                                                                    type="button" class="formFavourite"><i
                                                                    ...
                                                                    <div class="lower-content">
                                                                        ...
                                                                        <div>
                                                                            <ul
                                                                                ...
                                                                                <li> {{isset($usrProperty['Bedrooms']) ?  $usrProperty['Bedrooms'] : '0' }} Beds</li>
                                                                                <li> {{ isset($usrProperty['BathroomsFull']) ? $usrProperty['BathroomsFull'] : '0' }} Baths
                                                                                </li>
                                                                                <li> {{ isset($usrProperty['PropertyArea']) ? $usrProperty['PropertyArea'] : '0' }} sq. ft.
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                        @if ($usrProperty['PropertyStatus'] == 1)
                                                                            <div class="title-text">
                                                                                <h5><a
                                                                                        href="{{ route('home.property-detail', ['id' => $usrProperty['id']]) }}">{{ $usrProperty['PropertyAddress'] }}</a>
                                                                                </h5>
                                                                            </div>
                                                                        @else
                                                                            {{ isset($property['PropertyAddress']) ? $property['PropertyAddress'] : '' }}
                                                                        @endif
    ...
    <div class="modal depositeModal  reviewModal fade" id="examplenedepositeModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- <div class="profile_fields">
                                                ...
                                                <input type="text" value="" placeholder="Card Holder Name">
                                            ...
                                            <div class="profile_fields">
                                                ...
                                                <input type="text" value="" placeholder="Expiry">

                                            </div>

                                            <div class="profile_fields">

                                                <input type="text" value="" placeholder="CVC">

                                            </div>

                                            <div class="profile_fields">

                                                <input type="text" value="" placeholder="Billing Address">
                                            ...
                                            <div class="btn-box text-center">
                                                ...
                                                <a href="javascript:void(0)" class="theme-btn btn-one">Deposit</a>

                                            </div> -->

                    {{--

            <form id='checkout-form' method='post' action="{{url('/agent/create-charge')}}">
                ...
                <div class="profile_fields">
                    ...
                    <input type="text" value="" name="card_holder_name" placeholder="Card Holder Name" required>
                ...
                <div class="profile_fields">
                    ...
                    <input type="number" value="" name="amount" placeholder="Amount" required>
...
$('.purchase-lead-btn').on('click', function(e){
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.wallet_card_info button').click(function() {
                $('.flip_card_form').show('1000');
            })
        })
    ...
    <script>
        ...
        function initMap() {
            ...
            initMapDashboardCodeAddress(address);
        }

        function initMapDashboardCodeAddress(address) {
            var componentForm = {
                locality: 'long_name',
