																							...
																							<table width="100%"
																								...
																								<tr>
																									<td class="title-36 a-center pb-15"
																										...
																										<strong>There Is An Update On Your Ticket: ({{$data['ticket']['complaint']['subject']}})</strong>
																									</td>
																								</tr>
																								<tr>
																									<td class="text-16 lh-26 a-center pb-25"
                                                                                                        ...
                                                                                                        <p><b> Ticket Update Status: </b>{{isset($data['ticket']['status']) ? $data['ticket']['status'] : '' }}</p>                                                                                                    </td>
																								</tr>
																								<tr>
																									<td class="py-4"
