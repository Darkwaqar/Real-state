        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            <div class="page-title">
                ...
                <div class="float-left">
                    <h1 class="title">Buying Inquries</h1>                            </div>
        ...
        <div class="col-xl-12">
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title float-left">Buying Inquries</h2>
                    ...
                    <form action="" method="GET" enctype="multipart/form-data">
                        <div class="row mb-5">
                            ...
                            <div class="col-lg-3 col-md-6 col-12">
                                ...
                                <a class="btn btn-primary" href="{{ url('/admin/buying-guide') }}" >Clear Filters</a>
                            </div>
                        </div>
                    </form>
                    <div class="row">
                                ...
                                <table cellspacing="0" id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$lead->city}}</td>
                                            <td>{{$lead->question}}</td>
                                            @if (isset($lead->user) && !empty($lead->user['first_name']) && !empty($lead->user['last_name']))
                                            ...
                                            @empty
                                             <td>
                                                <button class="btn btn-default"> No Data Found </button>
                                            </td>
                                        </tr>
                                        @endforelse
