                ...
                // echo 'main if here =><br>';
                    ...
                    $currentIdskz =  Properties::updateOrCreate(
                        [
                            ...
                            'PropertyAddress' => $jsonToArr['UnparsedAddress'],
                            'BathroomsFull' => $jsonToArr['BathroomsFull'],
                            'Bedrooms' => $jsonToArr['BedroomsTotal'],
                            'PropertyArea' => $jsonToArr['BuildingAreaTotal']
                        ],
                        $property,
                    );
