@php
    $metaTitle = 'Aris Blog | Aris360 Blog';
    $metaDescription = "Explore insightful articles and engaging content on Aris Blog and Aris360 Blog.
     Stay up-to-date with the latest trends, news, and tips in our informative blogosphere.";
@endphp
<head>
              ...
              <div class="col-xl-12">
                 <div class="breadcrumb_content style2">
                    <ol class="breadcrumb">
                       ...
                       <li class="breadcrumb-item active" aria-current="page">Aris360 Blogs</li>
                    </ol>
                    <h2 class="breadcrumb_title">Aris360 Blogs</h2>
                 </div>
              </div>
           </div>
           <div class="row">
                             ...
                             <ul class="fp_meta float-start mb0">
                                ...
                                <li class="list-inline-item">
                                    <a href="javascript:void(0)">
                                        ...
                                        {{stringTodate($myblog['created_at'])}}
                                    </a>
                                </li>
                             </ul>
