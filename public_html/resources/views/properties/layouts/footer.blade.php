    ...
    <footer class="main-footer">
        <div class="footer-top bg-color-2">
            <div class="auto-container">
                        ...
                        <div class="footer-widget about-widget">
                            ...
                            <div class="text">
                                <p>
                                    ...
                                    © 2023 ARIS360 All rights reserved. Programs, rates, program terms and conditions
                                    subject to change without notice. Other restrictions and limitations apply.
                                    Additionally, ARIS360 is a real estate company in Washington state only. Though
                                    consumers may search for a lender on <a href="http://www.tristarfinance.com"
                        ...
                        <div class="post-inner d-flex align-items-start mt-4">
                            <div class="post" style="padding:5px;">
                                <div class="post-thumb">
                                    <img src="{{ asset('public/assets/images/equal-housing-opportunity-logo.png') }}"
                                        alt="" id="Myimg" class="rounded float-right lazy">
                                </div>
                            </div>
                            <p style="font-size:13px" class="mt-4">ARIS360 IS COMMITTED TO AND ABIDES BY THE FAIR
                                HOUSING ACT AND EQUAL OPPORTUNITY ACT.<br> READ ARIS360'S <a
                        ...
                        <div class="footer-widget links-widget ml-70">
                            ...
                            <div class="widget-content">
                                <ul class="links-list class">
                                    ...
                                    <li><a href="{{ route('home.our-community') }}">View Listings</a></li>
                                    <li><a href="{{ route('find-an-agent') }}">Find An ARIS360 Prime Agent</a></li>
                            ...
                            <div class="widget-content">
                                <ul class="info-list clearfix">
                                    ...
                                    <li><i class="fas fa-envelope"></i><a
                                            href="mailto:info@aris360.com">info@aris360.com</a></li>
                ...
                <div class="aris-ft-bttmSec">
                    <div class="aris-ft-bttmSec-logo">
                        <img class="lazy" src="{{ asset('public/assets/images/aris-aws-logo.png') }}">
                    </div>
                    <div class="aris-ft-bttmSec-logo">
                        <img class="lazy" src="{{ asset('public/assets/images/aris-dma-logo.png') }}">
                    </div>

                    <div class="aris-ft-bttmSec-logo">
                        <img class="mba-logo lazy" src="{{ asset('public/assets/images/mba-logo.png') }}">
                    </div>
                    <div class="aris-ft-bttmSec-logo">
                        <img class="mba-logo lazy" src="{{ asset('public/assets/images/gdpr.png') }}">
                    </div>
                    <div class="aris-ft-bttmSec-logo">
                        <img class="mba-logo lazy" src="{{ asset('public/assets/images/pci.png') }}">
                    </div>
                    <div class="aris-ft-bttmSec-logo">
                        <a href="https://docudash.net/" class="poweredByDocudashLogo">
                            <img src="{{ asset('public/assets/images/docudash.png') }}" class="img-fluid lazy"
                                alt="">
                        </a>
                    </div>
                ...
                <div class="col-12 mt-4 mb-5 d-flex justify-content-center">
                    <a class="btn btn-lg btn-outline-light footer_button" href="https://www.facebook.com/Aris360llc/"
                        target="_blank">
                        <i class="fab fa-facebook-f"></i>
                    </a>
                    <a class="btn btn-lg btn-outline-light footer_button" href="https://www.instagram.com/aris360llc/"
                        target="_blank">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a class="btn btn-lg btn-outline-light footer_button"
                        href="https://www.linkedin.com/company/aris360llc/" target="_blank">
                        <i class="fab fa-linkedin-in"></i>
                    </a>
                    <a id="twitterLink" class="btn btn-lg btn-outline-light footer_button twitter-hover"
                        href="https://twitter.com/aris360llc" target="_blank">
                        <img id="twitterImage" src="{{ asset('public/assets/images/x-twitter-white.png') }}"
                            alt="">
                    </a>
                    <a class="btn btn-lg btn-outline-light footer_button" href="https://www.youtube.com/@Aris-360"
                        target="_blank">
        ...
        <script>
            ...
            twitterLink.addEventListener('mouseover', function() {
                twitterImage.src = '{{ asset('public/assets/images/x-twitter-red.png') }}';
            });
            twitterLink.addEventListener('mouseout', function() {
                twitterImage.src = '{{ asset('public/assets/images/x-twitter-white.png') }}';
            });
        </script>
            ...
            <div class="auto-container">
                <div class="inner-box clearfix">
                    <figure class="footer-logo"><a href="{{ route('home') }}">
                            <img src="{{ asset('public/assets/images/Aris-Logonew2.png') }}" class="lazy"
                                alt=""></a>
                    </figure>
                    <ul class="footer-nav clearfix mt-5">
                        ...
                        <li><a href="https://nmlsconsumeraccess.org/TuringTestPage.aspx?ReturnUrl=/EntityDetails.aspx/COMPANY/43583"
                                target="_blank">NMLS Consumer Access</a></li>
            ...
            data.googleCityData.predictions.forEach(function(place, index) {
                ...
                const resultDiv = $('<div>')
                    ...
                    .append(
                        ...
                        .append($('<h1>').addClass('content_title').text(place.description.split(',')[
                        0])) // Use place.description
                        .append($('<h3>').addClass('content_subtitle').text(
                        parts)) // Use place.location if it exists in your data
                    );
                ...
                resultDiv.click(function() {
                    ...
                    var desiredLink = `/all-properties?${queryString}`;
                    window.location.href = currentDomain + desiredLink;
    ...
    <script src="{{ asset('public/assets/js/lenis.js') }}"></script>
    <script type="text/javascript">
        (function(d, src, c) {
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="login-page">
                        ...
                        <h4>Sign In</h4>
                        <small>Need an account? <a href="{{ url('/user/register') }}" class="">Signup ARIS360
                            </a></small>
                        <div class="social_login_opt">
                            <a href="javascript:(0)" class="google_btn">Continue with Google <img
                                    src="{{ url('public/assets/images/google.png') }}"></a>
                            <a href="javascript:(0)" class="facbook_btn">Continue with Facebook <img
                                    src="{{ url('public/assets/images/facebook.png') }}"></a>
                                    ...
                                    <div class="col-12">
                                        <div class="field-input">
                                            ...
                                            <small class="frgt-pswd"><a href="javascript:void(0)"
                                                    ...
                                                    data-target="#forgotModal">forgot your password</a></small>
                                        </div>
                                    </div>
                                    <div class="col-12">
    ...
    <div class="modal align-middle" id="skzModalNoti">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="skzmtle"></h5>
                    <button class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body" id="skzmbdy">
                </div>
    ...
    <!-- street view Modal -->
    <div class="modal align-middle" id="streeViewModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="login-page">
                        ...
                        @if (isset($propertyTypes) && count($propertyTypes) > 0)
                            <p class="title mt-3 mb-2 text-center"> Add New Team Member</p>
                            <form action="{{ route('agentTeam') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="profile_fields mt-5">
                                ...
                                <div class="profile_fields mt-5">
                                    <input type="submit" class="theme-btn btn-one" value="Add Member">
                                </div>
                            </form>
                        @else
                ...
                <div class="modal-body">
                    ...
                    <div class="send-btn d-flex justify-content-end">
                        <button id="shareSubmitButton"
                            class="theme-btn btn-one cta-btnshare button Button primary submit-button">Send</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-9HKZQDY5J7"></script>
    <script>
