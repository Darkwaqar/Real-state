    							...
    							<div class="col-lg-6 col-12 col-md-6  text-left">
    								 <div class="lendl-cardwrap">
    								     <div class="tri-imagewrap">
        								    <img src="public/images/aris-home-loans-profile.png" class="img-360 mb-2" alt="">
    								     </div>
    								     <div class="lendl-carddetail">
							            	<h5 class="mb-0 text-left">
                								<span class="tristart-text">Aris Home Loans</span>
						...
						<div class="in-blog-details-content-area">
							...
							<div class="in-blog-details-text-area about-wrapper headline ul-li-block pera-content">
								<div class="in-blog-details-text-wrap">
									...
									<h3>About Aris Home Loans</h3>

									<!--<div class="collapse collapse_show_less" id="collapseCompanyDetails">-->
									<div class="about-text-wrap">
											<p>Aris Home Loans is a national lender for borrowers who want to work with a great lender that goes above and beyond for them!</p>
										<!--<blockquote>-->
										...
										<div class="comment_element">
											...
											<div class="comment_content pera-content mt-2" style="border-bottom: unset !important;">
												<div class="reviews-headwrapper">
												    <h4 class="review-headtext"><a href="#">Get the Job done!</a></h4>
												    <span>12/18/2022</span>
												</div>
												<p class="review-gentext">L.P. from Tacoma, WA </p>
												<p>Hate shopping around? Look no further! This company is the REAL THING! 
I used Aris Home Loans services twice so far and yes there will be a third in the future!

They knows their stuff! Give them a call!</p>
											</div>
										</div>
									</li>
								 	...
								 	<li>
										<div class="comment_element">
											...
											<div class="comment_content pera-content mt-2" style="border-bottom: unset !important;">
												...
												<p class="review-gentext">Saeid Nejati from Snohomish, WA</p>
												<p>I worked with Aris Home Loans for my loan and had a fantastic experience finding the best rate and option based on my financial situation. They were extremely helpful, caring, and knowledgeable and assisted me through the entire process.</p>
											</div>
										</div>
									</li>
									<!--<li class="text-center mb-3">-->
