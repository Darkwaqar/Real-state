                                            ...
                                            <div class="select-box">
                                                <select class="wide" name="hometype">
                                                    @forelse($Structure as $hometype)
                                                        <option value="{{ $hometype['id'] }}" {{ in_array($hometype['id'], $property->StructureType->pluck('id')->toArray()) ? 'selected' : '' }}>
                                            ...
                                            <div class="select-box">
                                                <select class="wide" name="status">
                                                    ...
                                                    @if ($property['PublishStatus'])
                                                        <option value="{{ $property['PublishStatus'] }}">{{ $property['PublishStatus'] }}</option>
                                                    @endif
                                                    @forelse ($propertyTypes as $value)
                                                        @if ($value['PublishStatus'] != $property['PublishStatus'])
                                                            <option value="{{ $value['PublishStatus'] }}">{{ $value['PublishStatus'] }}</option>
                                                        @endif
                                                    @empty
                                                    @endforelse
                                                </select>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input type="text" name="PropertySubType" value="{{isset($property['propertyDetail']['PropertySubType']) ? $property['propertyDetail']['PropertySubType'] : ''}}"
                                                class="form-control"
                                                id="PropertySubType">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input
                                                ...
                                                type="text" name="SellingPrice" value="{{isset($property['PropetySellPrice']) ? $property['PropetySellPrice'] : ''}}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input type="text"
                                                onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                                name="HOAdues" value="{{isset($property['propertyDetail']['HOAdues']) ? $property['propertyDetail']['HOAdues'] : ''}}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input
                                                onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                                type="text" name="Beds"  value="{{isset($property['Bedrooms']) ? $property['Bedrooms'] : ''}}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input
                                                onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                                type="text" name="FullBaths" value="{{isset($property['BathroomsFull']) ? $property['BathroomsFull'] : ''}}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input
                                                onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                                type="text" name="OneQuarter"  value="{{isset($property['propertyDetail']['BathroomsOneQuarter']) ? $property['propertyDetail']['BathroomsOneQuarter'] : ''}}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input
                                                onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                                type="text" name="halfbaths" value="{{isset($property['BathroomsHalf']) ? $property['BathroomsHalf']: ''}}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input
                                                onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                                type="text" name="threeQuarter" value="{{isset($property['propertyDetail']['BathroomsThreeQuarter']) ? $property['propertyDetail']['BathroomsThreeQuarter'] : ''}}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input
                                                onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                                type="text" name="Finishedsquarefeet" value="{{isset($property['PropertyArea']) ? $property['PropertyArea'] : ''}}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input
                                                onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                                type="text" name="LotSize" value="{{isset($property['propertyDetail']['LotSizeSquareFeet']) ? $property['propertyDetail']['LotSizeSquareFeet'] : ''}}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input
                                                onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                                type="text" name="YearBuilt" value="{{isset($property['propertyDetail']['YearBuilt']) ? $property['propertyDetail']['YearBuilt'] : ''}}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input
                                                onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                                type="text" name="TaxYear" value="{{isset($property['propertyDetail']['TaxYear']) ? $property['propertyDetail']['TaxYear'] : ''}}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input
                                                onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                                type="text" name="TaxAnnualAmount" value="{{isset($property['propertyDetail']['TaxAnnualAmount']) ? $property['propertyDetail']['TaxAnnualAmount'] : ''}}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input
                                                onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                                type="text" name="EffectiveYearBuilt" value="{{isset($property['propertyDetail']['YearBuiltEffective']) ? $property['propertyDetail']['YearBuiltEffective'] : ''}}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input
                                                onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                                type="text" name="TotalRooms" value="{{isset($property['propertyDetail']['TotalRooms']) ? $property['propertyDetail']['TotalRooms'] : ''}}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group ">
                                            <input type="text" name="VirtualTourURL" {{isset($property['propertyDetail']['VirtualTourURLUnbranded']) ? $property['propertyDetail']['VirtualTourURLUnbranded'] : ''}}
                                                 class="form-control"
                                                id="VirtualTourURL">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group ">
                                            <textarea type="text" name="description" class="form-control wizard-required"
                                                id="description" >{{isset($property['PropertyDescription']) ? $property['PropertyDescription'] : ''}}</textarea>
                                            ...
                                            <div class="upload-inner centred">
                                              <div class="upload__box">
                                                <div class="upload-inner centred upload__btn-box">
                                                  <label class="upload-box upload__btn w-100" style="cursor: pointer">
                                                    <i class="fal fa-cloud-upload"></i>
                                                    <p>Upload images</p>
                                                    <input type="file" name="photos[]" accept="image/png, image/gif, image/jpeg" multiple="" data-max_length="100" class="form-control upload__inputfile d-none">
                                                  </label>
                                                </div>
                                                 ...
                                                 @foreach ($property['propertyMedia'] as $key => $image)
                                                    <div class="old-photo">
                                                        <div class="upload__img-box">
                                                            <div class="upload_image_div" style="background-image: url({{ $image['s3buckettempurl'] }})" data-number="{{ $key }}" data-file="{{ ($image['s3buckettempurl']) }}" class="img-bg">
                                                                <div class="upload__img-close">
                                                                    <i class="fas fa-times text-white" style="color: white;"></i>
                                                                </div>
                                                            </div>
                                ...
                                <div class="myprofile-section">
                                    <div class="property-details">
                                        ...
                                        <ul class="other-option APPLIANCES_details clearfix">
                                            ...
                                            <li>
                                              <div class="radio-box">
                                                <input name="appliance[]" type="checkbox" id="appliances_{{ $key }}" value="{{ $appliance['id'] }}" {{ $selected ? 'checked' : '' }}>
                                                <label for="appliances_{{ $key }}">
                                                  <img src="{{ asset('public/assets/images/' . $appliance->ApplianceIcon) }}" class="img-fluid check_icons" alt="">
                                                  <img src="{{ asset('public/assets/images/' . $appliance->ApplianceSelectedIcon) }}" class="img-fluid check_icons_red" alt="">
                                        ...
                                        <ul class="other-option APPLIANCES_details APPLIANCES_details_radio clearfix">
                                            ...
                                            <li>
                                              <div class="radio-box">
                                                <input name="basement[]" type="checkbox" id="basement_{{ $key }}" value="{{ $value['id'] }}" {{ $selected ? 'checked' : '' }}>
                                                <label for="basement_{{ $key }}">
                                                  <img src="{{ asset('public/assets/images/' . $value['BasementIcon']) }}" class="img-fluid check_icons" alt="">
                                                  <img src="{{ asset('public/assets/images/' . $value['BasementSelectedIcon']) }}" class="img-fluid check_icons_red" alt="">
                                                  {{ $value['BasementName'] }}
                                                </label>
                                              </div>
                                            </li>
                                        ...
                                        <ul class="other-option APPLIANCES_details clearfix">
                                            ...
                                            <li>
                                              <div class="radio-box">
                                                <input name="floor[]" type="checkbox" id="floor_{{ $key }}" value="{{ $value['id'] }}" {{ $selected ? 'checked' : '' }}>
                                                <label for="floor_{{ $key }}">
                                                  <img src="{{ asset('public/assets/images/' . $value['FloringeIcon']) }}" class="img-fluid check_icons" alt="">
                                                  <img src="{{ asset('public/assets/images/' . $value['FloringSelectedIcon']) }}" class="img-fluid check_icons_red" alt="">
                                                  {{ $value['FloringName'] }}
                                                </label>
                                              </div>
                                            </li>
                                        ...
                                        <ul class="other-option APPLIANCES_details clearfix">
                                            ...
                                            <li>
                                              <div class="radio-box">
                                                <input name="PropertyRooms[]" type="checkbox" id="room_{{ $key }}" value="{{ $value['id'] }}" {{ $selected ? 'checked' : '' }}>
                                                <label for="room_{{ $key }}">
                                                  <img src="{{ asset('public/assets/images/' . $value['RoomIcon']) }}" class="img-fluid check_icons" alt="">
                                                  <img src="{{ asset('public/assets/images/' . $value['RoomSelectedIcon']) }}" class="img-fluid check_icons_red" alt="">
                                                  {{ $value['RoomName'] }}
                                                </label>
                                              </div>
                                            </li>
                                        ...
                                        <ul class="other-option APPLIANCES_details clearfix">
                                            ...
                                            <li>
                                              <div class="radio-box">
                                                <input name="interior[]" type="checkbox" id="Interior_{{ $key }}" value="{{ $value['id'] }}" {{ $selected ? 'checked' : '' }}>
                                                <label for="Interior_{{ $key }}">
                                                  <img src="{{ asset('public/assets/images/' . $value['InteriorFeatureIcon']) }}" class="img-fluid check_icons" alt="">
                                                  <img src="{{ asset('public/assets/images/' . $value['InteriorFeatureSelectedIcon']) }}" class="img-fluid check_icons_red" alt="">
                                ...
                                <div class="myprofile-section">
                                    <div class="property-details">
                                        <ul class="other-option APPLIANCES_details clearfix">
                                            ...
                                            <li>
                                              <div class="radio-box">
                                                <input name="community[]" type="checkbox" id="com_{{ $key }}" value="{{ $value['id'] }}" {{ $selected ? 'checked' : '' }}>
                                                <label for="com_{{ $key }}">
                                                  <img src="{{ asset('public/assets/images/' . $value['CommunityFeatureIcon']) }}" class="img-fluid check_icons" alt="">
                                                  <img src="{{ asset('public/assets/images/' . $value['CommunityFeatureSelectedIcon']) }}" class="img-fluid check_icons_red" alt="">
                                        ...
                                        <ul class="other-option APPLIANCES_details APPLIANCES_details_radio clearfix">
                                            ...
                                            <li>
                                              <div class="radio-box">
                                                <input name="ArchitecturalStyle[]" type="checkbox" id="archi_{{ $key }}" value="{{ $value['id'] }}" {{ $selected ? 'checked' : '' }}>
                                                <label for="archi_{{ $key }}">
                                                  <img src="{{ asset('public/assets/images/' . $value['ArchitecturalIcon']) }}" class="img-fluid check_icons" alt="">
                                                  <img src="{{ asset('public/assets/images/' . $value['ArchitecturalSelectedIcon']) }}" class="img-fluid check_icons_red" alt="">
                                        ...
                                        <ul class="other-option APPLIANCES_details clearfix">
                                            ...
                                            <li>
                                              <div class="radio-box">
                                                <input name="exteriorFeatures[]" type="checkbox" id="exte_{{ $key }}" value="{{ $value['id'] }}" {{ $selected ? 'checked' : '' }}>
                                                <label for="exte_{{ $key }}">
                                                  <img src="{{ asset('public/assets/images/' . $value['ExterFeatureIcon']) }}" class="img-fluid check_icons" alt="">
                                                  <img src="{{ asset('public/assets/images/' . $value['ExterFeatureSelectedIcon']) }}" class="img-fluid check_icons_red" alt="">
                                        ...
                                        <ul class="other-option APPLIANCES_details clearfix">
                                            ...
                                            <li>
                                              <div class="radio-box">
                                                <input name="outDoor[]" type="checkbox" id="outdoor_{{ $key }}" value="{{ $value['id'] }}" {{ $selected ? 'checked' : '' }}>
                                                <label for="outdoor_{{ $key }}">
                                                  <img src="{{ asset('public/assets/images/' . $value['OutdooramenityIcon']) }}" class="img-fluid check_icons" alt="">
                                                  <img src="{{ asset('public/assets/images/' . $value['OutdooramenitySelectedIcon']) }}" class="img-fluid check_icons_red" alt="">
                                        ...
                                        <ul class="other-option APPLIANCES_details clearfix">
                                            ...
                                            <li>
                                              <div class="radio-box">
                                                <input name="parking[]" type="checkbox" id="parking_{{ $key }}" value="{{ $value['id'] }}" {{ $selected ? 'checked' : '' }}>
                                                <label for="parking_{{ $key }}">
                                                  <img src="{{ asset('public/assets/images/' . $value['ParkingFeatureIcon']) }}" class="img-fluid check_icons" alt="">
                                                  <img src="{{ asset('public/assets/images/' . $value['ParkingFeatureSelectedIcon']) }}" class="img-fluid check_icons_red" alt="">
                                        ...
                                        <ul class="other-option APPLIANCES_details clearfix">
                                            ...
                                            <li>
                                              <div class="radio-box">
                                                <input name="roof[]" type="checkbox" id="roof_{{ $key }}" value="{{ $value['id'] }}" {{ $selected ? 'checked' : '' }}>
                                                <label for="roof_{{ $key }}">
                                                  <img src="{{ asset('public/assets/images/' . $value['RoofIcon']) }}" class="img-fluid check_icons" alt="">
                                                  <img src="{{ asset('public/assets/images/' . $value['RoofSelectedIcon']) }}" class="img-fluid check_icons_red" alt="">
                                                  {{ $value['RoofName'] }}
                                                </label>
                                              </div>
                                            </li>
                                        ...
                                        <ul class="other-option APPLIANCES_details clearfix">
                                            ...
                                            <li>
                                              <div class="radio-box">
                                                <input name="propertyview[]" type="checkbox" id="view_{{ $key }}" value="{{ $value['id'] }}" {{ $selected ? 'checked' : '' }}>
                                                <label for="view_{{ $key }}">
                                                  <img src="{{ asset('public/assets/images/' . $value['ProperyViewIcon']) }}" class="img-fluid check_icons" alt="">
                                                  <img src="{{ asset('public/assets/images/' . $value['ProperyViewSelectedIcon']) }}" class="img-fluid check_icons_red" alt="">
                                ...
                                <div class="myprofile-section">
                                    <div class="property-details">
                                        <ul class="other-option APPLIANCES_details clearfix">
                                            ...
                                            <li>
                                              <div class="radio-box">
                                                <input name="propertycooling[]" type="checkbox" id="cooling_{{ $key }}" value="{{ $value['id'] }}" {{ $selected ? 'checked' : '' }}>
                                                <label for="cooling_{{ $key }}">
                                                  <img src="{{ asset('public/assets/images/' . $value['CoolingTypeIcon']) }}" class="img-fluid check_icons" alt="">
                                                  <img src="{{ asset('public/assets/images/' . $value['CoolingTypeSelectedIcon']) }}" class="img-fluid check_icons_red" alt="">
                                        ...
                                        <ul class="other-option APPLIANCES_details clearfix">
                                            ...
                                            <li>
                                              <div class="radio-box">
                                                <input name="propertyheating[]" type="checkbox" id="heating_{{ $key }}" value="{{ $value['id'] }}" {{ $selected ? 'checked' : '' }}>
                                        ...
                                        <ul class="other-option APPLIANCES_details clearfix">
                                            ...
                                            <li>
                                              <div class="radio-box">
                                                <input name="propertyfuel[]" type="checkbox" id="fuel_{{ $key }}" value="{{ $value['id'] }}" {{ $selected ? 'checked' : '' }}>
                                                <label for="fuel_{{ $key }}">
                                                  <img src="{{ asset('public/assets/images/' . $value['HeatingFuelIcon']) }}" class="img-fluid check_icons" alt="">
                                                  <img src="{{ asset('public/assets/images/' . $value['HeatingFuelSelectedIcon']) }}" class="img-fluid check_icons_red" alt="">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="form-group ">
                                                <input type="text" name="Address" class="form-control wizard-required"
                                                    id="autocomplete" value="{{isset($property['PropertyAddress']) ? $property['PropertyAddress'] : ''}}">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="form-group ">
                                                <input type="text" name="City"  class="form-control wizard-required"
                                                    id="locality" value="{{isset($property['CityName']) ? $property['CityName'] : ''}}">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="form-group ">
                                                <input type="text" name="State"  class="form-control wizard-required"
                                                    id="administrative_area_level_1" value="{{isset($property['StateOrProvince']) ? $property['StateOrProvince'] : ''}}">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="form-group ">
                                                <input type="text" name="CountyOrParish"
                                                    class="form-control wizard-required" id="country" value="{{isset($property['propertyDetail']['CountyOrParish']) ? $property['propertyDetail']['CountyOrParish'] : ''}}">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="form-group ">
                                                <input type="text" name="zipCode"  class="form-control wizard-required"
                                                    id="postal_code"  value="{{isset($property['PostalCode']) ? $property['PostalCode'] : ''}}">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="form-group ">
                                                <input type="text" name="Street"  class="form-control wizard-required"
                                                    id="street_number" value="{{isset($property['propertyDetail']['StreetName']) ? $property['propertyDetail']['StreetName'] : ''}}">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="form-group ">
                                                <input type="text" name="MLSArea" class="form-control wizard-required"
                                                    id="route" value="{{isset($property['propertyDetail']['MLSArea']) ? $property['propertyDetail']['MLSArea'] : ''}}">
                            ...
                            <fieldset class="wizard-fieldset">
                                ...
                                <div class="myprofile-section">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="form-group ">
                                                <input type="text" name="Topography" value="{{isset($property['propertyDetail']['Topography']) ? $property['propertyDetail']['Topography'] : ''}}"
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="form-group ">
                                                <input type="text" name="PowerCompany" value="{{isset($property['propertyDetail']['PowerCompany']) ? $property['propertyDetail']['Topography'] : ''}}"
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="form-group ">
                                                <input type="text" name="SewerCompany" value="{{isset($property['propertyDetail']['SewerCompany']) ? $property['propertyDetail']['SewerCompany'] : ''}}"
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="form-group ">
                                                <input type="text" name="HighSchoolDistrict" value="{{isset($property['propertyDetail']['HighSchoolDistrict']) ? $property['propertyDetail']['HighSchoolDistrict'] : ''}}"
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="form-group ">
                                                <input type="text" name="highSchool" value="{{isset($property['propertyDetail']['HighSchool']) ? $property['propertyDetail']['HighSchool'] : ''}}"
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="form-group ">
                                                <input type="text" name="MiddleOrJuniorSchool" value="{{isset($property['propertyDetail']['MiddleOrJuniorSchool']) ? $property['propertyDetail']['MiddleOrJuniorSchool'] : ''}}"
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="form-group ">
                                                <input type="text" name="ElementarySchool" value="{{isset($property['propertyDetail']['ElementarySchool']) ? $property['propertyDetail']['ElementarySchool'] : ''}}"
        ...
        filesArr.forEach(function(f, index) {
          ...
          if (imgArray.length >= maxLength) {
            ...
            reader.onload = function(e) {
              var html = "<div class='upload__img-box'><div class='upload_image_div' style='background-image: url(" +
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.upload__img-close').click(function() {
                var photoId = $(this).closest('.upload__img-box').find('input[name="existing_photos[]"]').val();
