    							...
    							<div class="col-lg-6 col-12 col-md-6  text-left">
    								 <div class="lendl-cardwrap">
    								     <div class="tri-imagewrap">
        								    <img src="public/images/mortgage-smarts-profile.png" class="img-360 mb-2" alt="">
    								     </div>
    								     <div class="lendl-carddetail">
							            	<h5 class="mb-0 text-left">
                								<span class="tristart-text">Mortgage Smarts</span>
						...
						<div class="in-blog-details-content-area">
							...
							<div class="in-blog-details-text-area about-wrapper headline ul-li-block pera-content">
								<div class="in-blog-details-text-wrap">
									...
									<h3>About Mortgage Smarts</h3>

									<!--<div class="collapse collapse_show_less" id="collapseCompanyDetails">-->
									<div class="about-text-wrap">
											<p>Mortgage Smarts is a national lender for borrowers who want to work with a great lender that goes above and beyond for them!</p>
										<!--<blockquote>-->
								...
								<ul class="comment_itemlist">
										...
										<div class="comment_element">
											...
											<div class="comment_content pera-content mt-2" style="border-bottom: unset !important;">
												<div class="reviews-headwrapper">
												    <h4 class="review-headtext"><a href="#">Awesome experience</a></h4>
												    <span>12/18/2022</span>
												</div>
												<p class="review-gentext">Pat from Bothell, WA</p>
												<p>I worked with them and they were very kind, patient and helpful. They replied all my questions very promptly. The loan process was very seamless and secure. My loan for closed in 25-27 days. Everyone I worked in this team is very approachable and reliable. I would strongly recommend Mortgage Smarts. They have got me the best interest rate in the market.</p>
											</div>
										</div>
									</li>
								 ...
								 <li>
										<div class="comment_element">
											...
											<div class="comment_content pera-content mt-2" style="border-bottom: unset !important;">
												<div class="reviews-headwrapper">
												    <h4 class="review-headtext"><a href="#">Easy, transparent, and prompt to work with Mortgage Smarts</a></h4>
												    <span>12/18/2022</span>
												</div>
												<p class="review-gentext">SuhasManangi from Redmond, WA</p>
												<p>We have worked with them on multiple loans, and each time they impressed with their level of commitment. They kept us in the loop throughout, always available for any questions on email, phone, and text, and proactive about when there are confusing steps in the process. We have recommended Mortgage Smarts to couple of our friends and they too had great reviews about him. We love to work with them again.</p>
											</div>
										</div>
									</li>
									<!--<li class="text-center mb-3">-->
