    							...
    							<div class="col-lg-6 col-12 col-md-6  text-left">
    								 <div class="lendl-cardwrap">
    								     <div class="tri-imagewrap">
        								    <img src="public/images/tr-star-finance-profile.png" class="img-360 mb-2" alt="">
    								     </div>
    								     <div class="lendl-carddetail">
							            	<h5 class="mb-0 text-left">
                								<span class="tristart-text">Tristar Finance</span>
						...
						<div class="in-blog-details-content-area">
							...
							<div class="in-blog-details-text-area about-wrapper headline ul-li-block pera-content">
								<div class="in-blog-details-text-wrap">
									...
									<h3>About Tristar Finance</h3>

									<!--<div class="collapse collapse_show_less" id="collapseCompanyDetails">-->
									<div class="about-text-wrap">
											<p>Tristar Finance is a national lender for borrowers who want to work with a great lender that goes above and beyond for them!</p>
										<!--<blockquote>-->
									...
									<li>
										<div class="comment_element">
											...
											<div class="comment_content pera-content mt-2" style="border-bottom: unset !important;">
												<div class="reviews-headwrapper">
												    <h4 class="review-headtext"><a href="#">Quick and a pleasure to work with!</a></h4>
												    <span>12/18/2022</span>
												</div>
												<p class="review-gentext">Emily Nelson from Renton, WA</p>
												<p>They were amazing partner with our home loan experience. They always responded within minutes of texting. They made themselves available at all hours and helped us find the lowest loan we’ve seen. We were very impressed with them and will be recommending them to others.</p>
											</div>
										</div>
									</li>
								 	...
								 	<li>
										<div class="comment_element">
											...
											<div class="comment_content pera-content mt-2" style="border-bottom: unset !important;">
												<div class="reviews-headwrapper">
												    <h4 class="review-headtext"><a href="#">Amazing!</a></h4>
												    <span>12/18/2022</span>
												</div>
												<p class="review-gentext">JoeyMarranca from Peoria, AZ</p>
												<p>They were incredible handling the entire mortgage process!  I would recommend Tristar Finance to ANYONE!</p>
											</div>
										</div>
									</li>
									<!--<li class="text-center mb-3">-->
