            ...
            <div class="map_rightCol">
                ...
                <footer class="main-footer">
                    ...
                    <!-- Start of aris360 Zendesk Widget script -->
                        <script id="ze-snippet" src="https://static.zdassets.com/ekr/snippet.js?key=34dd1433-3714-4c50-b0fc-7a6140ba66f4"> </script>
                ...
                function getPlaceId(urlParams) {
                    ...
                    geocoder.geocode(geocodeRequest, (results, status) => {
                        if (status === google.maps.GeocoderStatus.OK) {
                            ...
                            //@ts-ignore
                            featureLayer = zip.length > 0 ? map.getFeatureLayer("POSTAL_CODE") : map.getFeatureLayer("LOCALITY");
                ...
                // Check if cluster click processing is already in progress
                    ...
                    google.maps.event.addListenerOnce(map, 'idle', function() {
                        ...
                        $.ajax({
                            ...
                            enable();
                            $('#map-loader').hide();
                            processingClusterClick = false; // Set the flag to false after receiving the response
                            },
                            error: function(error) {
                            console.log(error);
                            enable();
                            $('#map-loader').hide();
                            processingClusterClick = false; // Set the flag to false even on error
                            }
                        });
                        });
