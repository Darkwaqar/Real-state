...
@section('content')
    ...
    <section class=" mtts-20">
        ...
        <div class="map_row">
            ...
            <div class="map_leftCol fixed_search_section  ">
                <div class="map_leftCol_inner position-relative">
                    ...
                    <div class="removeOutlineButton">
                        <button style="display:none" class="btn btn-warning buttonBoxBtns " id="RemoveOutlineMapBtn">
                                                            ...
                                                            <div class="custome-range-slider">
                                                                ...
                                                                <div class="range-wrap">
                                                                    <div class="range-wrapper">
                                                                        <span>Min</span>
                                                                        <input type="text" id="min-input" value="0">
                                                                    </div>
                                        ...
                                        <div class="widget-content">
                                            ...
                                            <ul class="info-list clearfix">
                                                ...
                                                <li>
                                                    ...
                                                    <p class="mb-0">5209 Lake Washington Blvd NE, Suite 220 </p>
                                                    <p class="mb-0">Kirkland, WA 98033-7355</p>
                                                </li>
        ...
        <script>
            ...
            function loadGoogleMapsScriptWithRetry(callback, retries = 3, delay = 1000) {
                function loadScript() {
                    ...
                    script.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyCSEEKrvzM3-vFcLEoOUf256gzLG7tyWWc&libraries=places&callback=' + callback;
            ...
            $(document).ready(function() {
                $(document).on('click', '#search-placeholder-icon', function() {
                    $('#search-placeholder').hide();
                    $('#search-input').attr('placeholder', 'Enter your city or ZIP code');
    ...
    font-weight: 300; color:#585858!important;">For Sale (${filter_property.length} Units)</span>
                                    </div>
                                </div>
                                ${filter_property.map(function(data) {
                                    return (
                                        `<div style="gap: 20px;" class="info_detail_box border-bottom d-flex align-items-center">
                    ...
                    marker.addListener("click", function(e) {
                        ...
                        if (filter_property.length > 1) {
                            ...
                            console.log(customInfoWindow, 'lllololo')
                        ...
                        activeMarker = this;
                        var newIcon = '{{ asset('public/assets/images/marker-wide-img_green.png') }}';
                        ...
                        if (clickedId === location.id) {
                            if (this.getIcon().url ===
                                ...
                                console.log(this.getIcon().url, 'this.getIcon().url')
                ...
                function getPlaceId(urlParams) {
                    ...
                    $(".propertyBox").hover(function() {
                        ...
                        removeMarker();
                        const blackIcon = '{{ asset('public/assets/images/marker-wide-img_green.png') }}';
                        activeMarker.setIcon({
                            url: blackIcon,
                            size: new google.maps.Size(60, 28),
                            scaledSize: new google.maps.Size(60, 28)
                ...
                if (urlParams.get('search')) {
                    ...
                    console.log(urlParams.has('search'), 'search')
                }
            ...
            $("#drawOnMapBtn").click(function(e) {
                ...
                function handleMouseUp(coordinates) {
                    console.log("handleMouseUp: " + cancel);
                    if (cancel) {
                        $('#map-loader').show();
                        disable();
                        clearDrawing();
            ...
            document.getElementById('RemoveOutlineMapBtn').addEventListener('click', () => {
                $('#search-placeholder').hide();
                search.setAttribute('placeholder', 'Enter your city or ZIP code')
                $('#map-loader').show();
                disable();
                $('#RemoveOutlineMapBtn').hide();
                global_data.polygonCoordinates = [];
            ...
            function sendSearchRequest(fromSearch) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (fromSearch) {
                            console.log('search second if')
                            initializeMap(response.pagination, type);
                            fromSearch = false;
                        } else {
                            console.log('search second ekse')
                            clearMarkers();
    ...
    @if (!auth()->check())
        <section class="bottom_fix">
            <div class="container">
                ...
                <div class="d-flex">
                    <a href="{{ url('/user/register') }}" type="submit" class="theme-btn btn-one mr-3">Sign Up
                        Now
                    </a>
                    <a href="{{ route('login') }}" type="submit" class="theme-btn btn-one">Sign In</a>
                </div>
            </div>
        </section>
    @endif
    ...
    <script type="text/javascript">
        ...
        function testingSameer(response, skzCategory, page) {
            if (response.count && typeof response.count === 'number' && response.count > 0) {
                if (response.count <= 40) {
                    var paginationText = 'Showing ' + response.count + ' of ' + response.count;
                } else {
                    var paginationText = 'Showing ' + 40 + ' of ' + response.count;
                }
            ...
            if (paginatedData.length > 0) {
                $.each(paginatedData, function(key, value) {
                    ...
                    htmlSearch += `
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12  propertyBox prp_div_${ id }" data-lat="${value.PropertyLatitude}" data-lng="${value.PropertyLongitude}" data-price="${price}">
                        <div class="feature-block">
                            ...
                            <div id='prp_${ id }' class="inner-box prp_${ id } rmv-border" data-lat="${value.PropertyLatitude}" data-lng="${value.PropertyLongitude}" data-price="${price}">
                                ...
                                <span class="category2">${value.PublishStatus}</span>
                                ${hoursAgo != '' ? '<span class="category4"> NEW '+ hoursAgo +'</span>' : ''}
            ...
            generatePagination(response, skzCategory, totalPages, page, total_records);
        }
