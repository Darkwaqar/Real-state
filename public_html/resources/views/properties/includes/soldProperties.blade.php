        ...
        <div class="feature-block-one">
            <div class="inner-box">
                <div class="image-box">
                    ...
                    <figure class="image"><img src="{{ isset($property['preffered_media'][0]['id']) ? $property['preffered_media'][0]['s3buckettempurl'] : ''}}"
                    alt="">  </figure></a>
                    <!--<div class="batch"></div>-->
                ...
                <div class="lower-content">
                    ...
                    <div class="title-text">
                        ...
                        <h5><a href="{{ route('home.property-detail', ['id' => $property['id']]) }}">{{@substr($property['PropertyAddress'], 0, 80) . '...'}}</a></h5>
                    </div>
