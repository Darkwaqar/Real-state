...
@section('content')
        ...
        <div class="map_row">
            ...
            <div class="map_rightCol">
                                                            ...
                                                            <div class="custome-range-slider">
                                                                ...
                                                                <div class="range-wrap">
                                                                    <div class="range-wrapper">
                                                                        <span>Min</span>
                                                                        <input id="min-input" type="text" value="0">
                                                                    </div>
                ...
                <div class="row item-shorting mt-3">
                    ...
                    <a class="map_custom_btn" href="javascript:void(0)">Map <i class="fas fa-map"></i></a>
        ...
        <script type="text/javascript">
            ...
            function initializeMap(properties, type) {
                ...
                markers = locations.map(function(location) {
                    ...
                    //     propertyListingBox.addEventListener("mouseenter", function(marker) {
                    //         return function() {
    ...
    @if (!auth()->check())
        <section class="bottom_fix">
            <div class="container">
                ...
                <div class="d-flex">
                    <a class="theme-btn btn-one mr-3" type="submit" href="{{ url('/user/register') }}">Sign Up
                        Now
                    </a>
                    <a class="theme-btn btn-one" type="submit" href="{{ route('login') }}">Sign In</a>
                </div>
            </div>
        </section>
    @endif
    ...
    <script type="text/javascript">
        ...
        function testingSameer(response, skzCategory, page) {
            ...
            console.log(response, "response.pagination.length")
            console.log(response.count, "response.count")
            console.log(page, "page")
            for (item of response.pagination) {
                let property_listing_box = document.getElementById(`prp_${item.id}`);
                console.log(item.id, 'property_listing_box')
            ...
            //             paginationText = 'Showing ' + response.count + ' of ' + response.count;
            //         } else {
            //             paginationText = 'Showing ' + 40 + ' of ' + response.count;
            //         }
            ...
            if (response.pagination.length > 0) {
                if (response.pagination.length > 0) {
                    ...
                    if (response.pagination.length <= 40) {
                        paginationText = 'Showing ' + response.pagination.length + ' of ' + response.pagination.length;
                    } else {
                        paginationText = 'Showing ' + 40 + ' of ' + response.pagination.length;
                    }
                }
            } else {
            ...
            var markers = locations.map(function(location) {
                ...
                marker.addListener("click", function(e) {
                    ...
                    if (activeMarker !== null && activeMarker !== this) {
                        ...
                        activeMarker.getLabel().color = '#fff';
                        console.log(this.getLabel(), ' this.getLabel()')
                    }
