                    ...
                    <div class="admin-prof-tabs">
                        <div class="auto-container">
                            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-notification-tab" data-toggle="pill" href="#pills-notification" type="button" role="tab" aria-controls="pills-notification" aria-selected="true">Inquiries</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-setting-tab" data-toggle="pill" href="#pills-setting" type="button" role="tab" aria-controls="pills-setting" aria-selected="false">Property Listed</button>
                                </li>
                                {{-- <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content mt-3" id="pills-tabContent">
                                            ...
                                            <div class="prof-setting">
                                                <p class="text_modal_btn">
                                                    <span>
                                                        ...
                                                        @if (Auth::user()->type == 'aris')
                                                        Aris360 Featured Agent
                                                        @elseif (getUserSessionData('type') == 'featured')
                                                    ...
                                                    <div class="ff_one ">
                                                        ...
                                                        <div class="icon">
                                                            <span class="flaticon-home">
                                                                <img src="{{asset('public/assets/images/negotiation.png')}}" class="img-fluid">
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="lead-inner-content">
                                      <div class="lead-leftSect">
                                        ...
                                        <a class="nav-link {{($key == 0) ? 'active':''}}" id="v-pills-home-tab" data-toggle="pill" href="#myleads-v-pills-{{$key}}" data-lead="{{$MyPropertyLead->id}}" role="tab" aria-controls="v-pills-home" aria-selected="true">
                                                <h5 class="prof_title">{{$MyPropertyLead->Lead->name}} <small>{{ \Carbon\Carbon::parse($MyPropertyLead->created_at)->toFormattedDateString()}}</small></h5>
                                                <p class="text_modal_btn"><span><i class="fas fa-map-marker-alt"></i> {{$MyPropertyLead->Lead->city}}</span></p>
                                                <p class="text_modal_btn"><span><i class="fas fa-coins"></i> 75 Aris credits</span></p>
                                        </a>
                                        @empty
                                            <p>No record Found</p>
                                        @endforelse
                                    ...
                                    <div class="lead-rightSect">
                                        ...
                                        @forelse($myPropertyLeads as $key => $MyPropertyLead)
                                        <div class="tab-pane fade show {{($key == 0) ? 'active':''}}" id="myleads-v-pills-{{$key}}" role="tabpanel" aria-labelledby="myleads-v-pills-{{$key}}">
                                              ...
                                              <ul class="feature_lead_list mt-2">
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        ...
                                                        <p>
                                                            <span>Name:</span>
                                                            <span>{{$MyPropertyLead->Lead->name}}</span>
                                                        </p>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        ...
                                                        <p>
                                                            <span>Email:</span>
                                                            <span>{{$MyPropertyLead->Lead->email}}</span>
                                                        </p>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        ...
                                                        <p>
                                                            <span>Contact:</span>
                                                            <span>{{$MyPropertyLead->Lead->contact}}</span>
                                                        </p>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        ...
                                                        <p>
                                                            <span>City:</span>
                                                            <span>{{$MyPropertyLead->Lead->city}}</span>
                                                        </p>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        ...
                                                        <p>
                                                            <span>State:</span>
                                                            <span>{{$MyPropertyLead->Lead->state}}</span>
                                                        </p>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <span><img src="{{asset('public/assets/images/buyer-seller.png')}}"></span>
                                                        <p>
                                                            <span>Lead Type:</span>
                                                            <span>{{$MyPropertyLead->Lead->lead_type}}</span>
                                                        </p>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        ...
                                                        <p>
                                                            ...
                                                            <span>{{$MyPropertyLead->Lead->property_type}}</span>
                                                        </p>
                                                    </a>
                                                </li>
                                            </ul>
                                            <div class="btn-box mb-3">
                                                <a href="javascript:void(0)" class="theme-btn btn-one">Call</a>
                                                <a href="javascript:void(0)" class="theme-btn btn-one">Email</a>
                                            </div>
                                            <div class="mapouter"><div class="gmap_canvas"><iframe width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=5209%20Lake%20Washington%20Blvd%20NE,%20Suite%20220%20%20Kirkland,%20WA%2098033-7355&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://123movies-i.net">escape room 2 123movies</a><br><style>.mapouter{position:relative;text-align:right;height:500px;width:600px;}</style><a href="https://www.embedgooglemap.net"></a><style>.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:600px;}</style></div></div>
                                          </div>
                                        </div>
                                        ...
                                        {{-- <div class="lead-leftSect">
                                          ...
                                          <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            @forelse($myPropertyLeads as $key => $propertyLead)

                                                <a class="nav-link {{($key == 0) ? 'active':''}}" id="v-pills-home-tab" data-toggle="pill" href="#v-pills2-{{$key}}" data-lead="{{$propertyLead->id}}" role="tab" aria-controls="v-pills-home" aria-selected="true">
                                                    <h5 class="prof_title">{{$propertyLead->Lead->name}}<small>{{ \Carbon\Carbon::parse($propertyLead->created_at)->toFormattedDateString()}}</small></h5>
                                                    <p class="text_modal_btn"><span><i class="fas fa-map-marker-alt"></i> {{$propertyLead->Lead->city}}</span></p>
                                                    <p class="text_modal_btn"><span><i class="fas fa-coins"></i> 75 Aris credits</span></p>
                                                </a>
                                            @empty
                                                <p>No record Found</p>
                                                  ...
                                                  <ul class="feature_lead_list mt-2">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            ...
                                                            <p>
                                                                <span>Email:</span>
                                                                <span>roitaroa@emample.com</span>
                                                            </p>
                                                        </a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <span><img src="public/assets/images/buyer-seller.png"></span>
                                                            <p>
                                                                <span>Lead Type:</span>
                                                                <span>Buyer</span>
                                                            </p>
                                    ...
                                    <div class="lead-inner-content">
                                        <div class="lead-leftSect">
                                            ...
                                            @forelse($propertyLeads as $key => $propertyLead)
                                                @if($propertyLead->lead_purchased)
                                                {{-- @if($propertyLead->lead_purchased->agent_id !== getUserId())  --}}
                                                  {{-- @if($propertyLead->lead_purchased->agent_id != getUserId())  --}}
                                                  <a class="nav-link {{($key == 0) ? 'active':''}}" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-{{$key}}" data-lead="{{$propertyLead->id}}" role="tab" aria-controls="v-pills-home" aria-selected="true">
                                                      <h5 class="prof_title">{{$propertyLead->name}} <small>{{ \Carbon\Carbon::parse($propertyLead->created_at)->toFormattedDateString()}}</small></h5>
                                                      <p class="text_modal_btn"><span><i class="fas fa-map-marker-alt"></i> {{$propertyLead->city}}</span></p>
                                                      <p class="text_modal_btn"><span><i class="fas fa-coins"></i> 75 Aris credits</span></p>
                                                  </a>
                                        ...
                                        <div class="lead-rightSect">
                                            <div class="tab-content" id="v-pills-tabContent">
                                                @forelse($propertyLeads as $key => $propertyLead)
                                                    <div class="tab-pane fade show {{($key == 0) ? 'active':''}}" id="v-pills-{{$key}}" role="tabpanel" aria-labelledby="v-pills-{{$key}}">
                                                        <div class="lead_right_innercontent">
                                                        <ul class="feature_lead_list mt-2">
                                                            <li>
                                                                <a href="javascript:void(0)">
                                                        ...
                                                        <div class="btn-box mb-3">
                                                          <form method="POST" action="{{ url("wallet/purchase-lead") }}">
                                                            @csrf
                                                            <input type="hidden" name="lead_id" value="{{$propertyLead->id}}">
                                                            <button type="submit" class="theme-btn btn-one purchase-lead-btn">Purchase lead</button>
                                                          </form>
                                                        </div>
                                                        <div class="mapouter"><div class="gmap_canvas"><iframe width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=5209%20Lake%20Washington%20Blvd%20NE,%20Suite%20220%20%20Kirkland,%20WA%2098033-7355&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://123movies-i.net">escape room 2 123movies</a><br><style>.mapouter{position:relative;text-align:right;height:500px;width:600px;}</style><a href="https://www.embedgooglemap.net"></a><style>.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:600px;}</style></div></div>
                                                        </div>
                            ...
                            <div class="tab-pane fade" id="pills-wallet" role="tabpanel" aria-labelledby="pills-wallet-tab">
                                <div class="container">
                                              ...
                                              <tbody>
                                                @forelse($walletTransactionsHistory as $key => $walletTransactionsHistories)
                                                    <tr>
                                                        ...
                                                        <td>{{ \Carbon\Carbon::parse($walletTransactionsHistories->created_at)->format('d/m/Y')}}</td>
                                    ...
                                    action="{{url('/agent/create-charge')}}"
                                    method="post"
                                    ...
                                    id="payment-form">
                                      ...
                                      <div class="form-container">
                                        ...
                                        <div class="field-container">
                                          ...
                                          <input type="text" id="cardnumber" class="card-number" name="card_number">
                                        ...
                                        <div class="field-container">
                                          ...
                                          <input type="text" id="expirationdate" class="card-expiry-month" name="expiry_month" size="2" placeholder="MM" maxlength="2">
                                          {{-- <input id="expirationdate" type="text" pattern="[0-9]*" inputmode="numeric"> --}}
                                        </div>
                                        <div class="field-container">
                                          <label for="expirationdate">Expiration year</label>
                                          <input type="text" id="expirationdate" class="card-expiry-year" name="expiry_year" size="4" placeholder="YYYY" maxlength="4">
                                          {{-- <input id="expirationdate" type="text" pattern="[0-9]*" inputmode="numeric"> --}}
                                        </div>
                                        <div class="field-container">
                                          <label for="securitycode">Security Code</label>
                                          <input id="securitycode" type="text" pattern="[0-9]*" inputmode="numeric" class="card-cvc" name="cvc">
                                        ...
                                        <div class='form-row row'>
                                          <div
                                              class='col-md-12 error form-group d-none'>
                                            ...
                                            <div class="main_trans_wrap">
                                                ...
                                                <table class="table table-bordered">
                                                  ...
                                                  <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{ \Carbon\Carbon::parse($agentInuiry['created_at'])->format('d/m/Y')}}</td>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{$tour->phone}}</td>
                                                            <td>{{$tour->message}}</td>
                                                            <td><a href="{{ url('property-detail/'.$tour['propertyTour'][0]['id']) }}">
                                                                {{$tour['propertyTour'][0]['PropertyAddress']}}</a></td>
                                                            <td>{{ \Carbon\Carbon::parse($tour->date)->format('d/m/Y')}}/ {{ $tour->time }}</td>
                            ...
                            <div class="tab-pane fade" id="pills-setting" role="tabpanel" aria-labelledby="pills-setting-tab">
                                <div class="container">
                                    ...
                                    <div class="trans_list_2">
                                            ...
                                            <div class="row">
                                                @if (isset($userProperties) && count($userProperties) > 0)
                                                @foreach ($userProperties as $usrProperty)
                                                                ...
                                                                <div class="inner-box">
                                                                    <div class="image-box">
                                                                        @if ($usrProperty['PropertyStatus'] == 1)
                                                                            @php
                                                                                $urlLinkPro = url('/property-detail').'/'.$usrProperty['id'];
                                                                            @endphp
                                                                        @elseif ($usrProperty['PropertyStatus'] == 2)
                                                                            @php
                                                                                $urlLinkPro = 'javascript:void(0)';
                                                                            @endphp
                                                                        @endif
                                                                        ...
                                                                        <a href="{{  $urlLinkPro }}">
                                                                            <figure class="image">
                                                                                @php
                                                                                    $imageexist = '';
                                                                                @endphp
                                                                                @if(isset($usrProperty['preffered_media']) && !empty($usrProperty['preffered_media'][0]['MediaURL']))
                                                                                    @php
                                                                                        $imageexist = $usrProperty['preffered_media'][0]['MediaURL'];
                                                                                    @endphp
                                                                                @endif
                                                                                <img src="{{ asset('public/images/').'/'.$imageexist }}" alt="">
                                                                            </figure>
                                                                        </a>
                                                                        <!--<div class="batch"></div>-->
                                                                        <span class="category">
                                                                    ...
                                                                    <div class="lower-content">
                                                                        <div class="price-info custom_price_info">
                                                                            <h4 class="mt-2">${{ $usrProperty['PropetySellPrice'] }}</h4>
                                                                        </div>
                                                                        <div>
                                                                            <ul class="more-details mt-2 clearfix">

                                                                            <li><i class="icon-14"></i>  {{ $usrProperty['Bedrooms'] }} Beds</li>

                                                                            <li><i class="icon-15"></i> {{ $usrProperty['BathroomsFull'] }} Baths</li>

                                                                            <li><i class="icon-16"></i> {{ $usrProperty['property_detail']['LotSizeSquareFeet'] }} Square Feet</li>
                                                                        ...
                                                                        <div class="title-text">
                                                                            ...
                                                                            <h5>
                                                                                <a href="{{  $urlLinkPro }}">
                                                                                    {{ substr($usrProperty['PropertyDescription'],0,100) }}
                                                                                </a>
                                                                            </h5>
                                                                        </div>
                                                                        <div class="listing_key_section">
                                                                            <ul>
                                                                                <li>
                                                                                    <p>{{ $usrProperty['ListingId'] }}</p>
                                                                                </li>
                                                                                <li>
                                                                                    <p>{{ $usrProperty['property_detail']['PropertyType'] }}</p>
                                                                                </li>

                                                                            </ul>
                                                                        </div>
                                                                        {{-- <h5 class="mt-2">Listing Firm: .</h5> --}}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                @endforeach
                                                @else
                                                    <div class="col-lg-4 col-md-6 col-12 alert alert-primary" role="alert">
                                                        The data is not available.
                                                    </div>
                                                @endif
                                            </div>
                                            ...
                                            {{-- <div class="main_trans_wrap">
                                                @if (isset($userProperties) && count($userProperties) > 0)
                                                    <div class="row trans_history" style="background-color: #de1e25;">
                                                        <div class="col-lg-2">
                                                            <p class="text-light">Property ID</p>
                                                        </div>
                                                        <div class="col-lg-2">
                                                            <p class="text-light">Date Listed</p>
                                                        </div>
                                                        <div class="col-lg-2">
                                                            <p class="text-light">Property Type</p>
                                                        </div>
                                                        <div class="col-lg-2">
                                                    ...
                                                    @foreach ($userProperties as $usrProperty)
                                                        <div class="row trans_history">
                                                            <div class="col-lg-2">
                                                                <p>
                                                                    @if ($usrProperty['PropertyStatus'] == 1)
                                                                        <a href="{{ url('/property-detail/').'/'.$usrProperty['id'] }}">
                                                                            {{ $usrProperty['ListingId'] }}
                                                                        </a>
                                                            ...
                                                            <div class="col-lg-2">
                                                                <p>{{ date('d/M/Y', strtotime($usrProperty['created_at'])) }}</p>
                                                            </div>
                                                            <div class="col-lg-2">
                                                                <p>
                                                                    @if (isset($usrProperty['property_detail']['PropertyType']))
                                                                    {{ $usrProperty['property_detail']['PropertyType'] }}
                                                                    @else
                                                                        N/A
                                                                    @endif
                                                                </p>
                                                            ...
                                                            <div class="col-lg-2">
                                                                <p>{{ $usrProperty['CityName'] }}</p>
                                                            </div>
                                                            <div class="col-lg-2">
                                                                <p>{{ $usrProperty['StateOrProvince'] }}</p>
                                                            </div>
...
<div class="modal depositeModal  reviewModal fade" id="examplenedepositeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
