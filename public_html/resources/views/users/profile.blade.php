                                                ...
                                                <div class="team-inner d-block">
                                                    <div class="team-overflow">
                                                        <div class="team-photo">
                                                            <div class="team-img">
                                                                <a href="{{url('real-estate-agent-detail/'.(isset($team['slug']) ? $team['slug'] : ''))}}" target="_blank">
                                                                    <img src="{{ asset('public/images/userdp/' . (isset($team['user_dp']) ? $team['user_dp'] : '')) }}"
                                                                    alt="agent-2" class="img-fluid w-100 agent_team_max_width">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="team-details">
                                                        <h5><a href="{{url('real-estate-agent-detail/'.(isset($team['slug']) ? $team['slug'] : ''))}}" target="_blank">
                                                            {{ isset($team['first_name']) && isset($team['last_name']) ? $team['first_name'] . ' ' . $team['last_name'] : '' }}
                                                        </a></h5>
                                                        <p>{{  isset($team['state']) && isset($team['city']) ? $team['state'] .', '. $team['city'] : ''}}</p>
                                                    </div>
