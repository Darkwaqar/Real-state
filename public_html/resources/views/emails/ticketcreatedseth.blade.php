																							...
																							<table width="100%"
																								...
																								<tr>
																									<td class="title-36 a-center pb-15"
																										...
																										<strong>A New Ticket Is Generated By: ( {{$data['user_complaints']['first_name']}} )</strong>
																									</td>
																								</tr>
																								<tr>
																									<td class="text-16 lh-26 a-center pb-25"
																										...
																										<p><b>Ticket No: </b>{{isset($data['ticket_no']) ? $data['ticket_no'] : '' }}</p> 
																										<p><b>Subject: </b>{{isset($data['subject']) ? $data['subject'] : '' }}</p>
																										<p><b>Description: </b>{{isset($data['description']) ? $data['description'] : '' }}</p>
																										<p><b>Status: </b>{{isset($data['status']) ? $data['status'] : '' }}</p>
                                                                                                    </td>
																								</tr>
																								<tr>
																									<td class="py-4"
