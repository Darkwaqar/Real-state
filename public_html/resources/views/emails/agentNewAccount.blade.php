...
<head>
	...
	<!--<![endif]-->
	<title>Apply Aris360 Agent</title>
	<!--[if gte mso 9]>
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td class="text-12 c-grey l-grey a-right py-20"
														...
														<a href="{{ url('/') }}" target="_blank" class="link c-grey"
															style="text-decoration:none; color:#6e6e6e;"><span
																class="link c-grey"
																style="text-decoration:none; color:#6e6e6e;">Click here to visit aris360.com</span></a>
													</td>
												</tr>
											</table> <!-- END Top -->
																							...
																							<table width="100%"
																								...
																								<tr>
																									<td class="fluid-img img-center pb-50"
																										...
																										<img src=" {{ 'https://aris360.com/public/images/emails/img3.png' }}"
																											width="200"
																											height="200"
																											border="0"
																											alt="" />
																								...
																								<tr>
																									<td class="title-36 a-center pb-15"
																										style="font-size:33px; line-height:40px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
																										<strong>Thank You
																											For Applying To Become An {{ getAgentType($mydata['agentType']) }}!</strong>
																									</td>
																								</tr>
																								<tr>
																									<td class="text-16 lh-26 a-center pb-25"
																										...
																										Your profile is under review and our team will get back to you.
																									</td>
																								</tr>
														...
														<table border="0" cellspacing="0" cellpadding="0">
															<tr>
																<td class="img" width="34"
																	...
																	<a href="https://www.facebook.com/Aris360llc/" target="_blank"><img
														...
														<table border="0" cellspacing="0" cellpadding="0">
															<tr>
																<td class="img" width="117"
																	style="font-size:0pt; line-height:0pt; text-align:left;">
																	<a href="{{ url('/') }}" target="_blank"><img
																			src="{{ 'https://aris360.com/public/images/emails/appstore.png' }}" width="117"
