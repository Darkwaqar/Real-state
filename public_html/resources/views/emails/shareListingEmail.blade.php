...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        .gradient {
            background: linear-gradient(90deg, rgba(81, 1, 4, 1) 0%, rgba(190, 9, 14, 1) 100%, rgba(81, 1, 4, 1) 50%);
        }
                    ...
                    <table width="600" border="0" cellspacing="0" cellpadding="0" class="m-shell">
                        <tr>
                            <td class="td"
                                                                        ...
                                                                        <tr>
                                                                            <td class="img-center p-30 px-15"
                                                                                ...
                                                                                <a href="#" target="_blank"><img
                                                                                        src="{{'https://www.aris360.com/public/images/emails/logo-text.png'}}"
                                                                                        width="350" height="80"
                                                                                        border="0" alt="" /></a>
                                                                            </td>
                                                                        </tr>
                                                                                            ...
                                                                                            <table width="100%"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="fluid-img img-center pb-50"
                                                                                                        ...
                                                                                                        <img src="{{"https://aris360.com/public/images/emails/img7.png"}}"
                                                                                                            width="200"
                                                                                                            height="200"
                                                                                                            border="0"
                                                                                                            alt="" />
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td class="pb-15"
                                                                                                            ...
                                                                                                            <table
                                                                                                                ...
                                                                                                                cellpadding="0">
                                                                                                                <tr>
                                                                                                                    <td class="title-26 a-center pb-10"
                                                                                                                        style="font-size:35px; line-height:10px; color:#000; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 22px;">
                                                                                                                        Property Shared
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td
                                                                                                                                    ...
                                                                                                                                    <table
                                                                                                                                        ...
                                                                                                                                        >
                                                                                                                                        <tr>
                                                                                                                                            <td class="text-14 lh-24"
                                                                                                                                                style="font-size:20px; color:#000000; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important; line-height: 32px;">
                                                                                                                                                Name :
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="text-16 lh-26 a-center pb-25"
                                                                                                        style="font-size:20px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 35px; text-align:center; padding-bottom: 25px;">
                                                                                                       {{$userMessage}}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                        ...
                                                                                                        <table
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td class="btn-16 c-white l-white"
                                                                                                                    bgcolor="#b90000"
                                                                                                                    style="font-size:16px; line-height:20px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; border-radius:25px; min-width:auto !important; color:#ffffff;">
                                                                                                                    <a href="{{url('/property-detail' . '/' . $property['id'])}}"
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="link c-white"
                                                                                                                            style="text-decoration:none; color:#ffffff;">View
                                                                                                                            Property</span>
                                                                                                                    </a>
                                                                                                                </td>
                                                                                                            </tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="p-50 mpx-15" bgcolor="#272a2f"
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td class="img" width="34"
                                                                    ...
                                                                    <a href="#" target="_blank"><img
                                                                            src="{{'https://www.aris360.com/public/images/emails/Facebook_Logo.png'}}"
                                                                ...
                                                                <td class="img" width="34"
                                                                    style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                    <a href="https://www.instagram.com/aris360llc/" target="_blank"><img
                                                                            src="{{'https://aris360.com/public/images/emails/instagram-logo.png'}}"
                                                                            width="34" height="34" border="0"
                                                                            alt="" /></a>
                                                                </td>
                                                                <td class="img" width="15"
                                                                ...
                                                                <td class="img" width="34"
                                                                    style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                    <a href="https://linkedin.com/company/aris360llc/" target="_blank"><img
                                                                            src="{{'https://aris360.com/public/images/emails/linkedin-logo.png'}}"
                                                                            width="34" height="34" border="0"
                                                                            alt="" /></a>
                                                                </td>
                                                                <td class="img" width="15"
                                                                ...
                                                                <td class="img" width="34"
                                                                    style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                    <a href="https://twitter.com/aris360llc" target="_blank"><img
                                                                            src="{{'https://aris360.com/public/images/emails/twitter-logo.png'}}"
                                                                            width="34" height="34" border="0"
                                                                            alt="" /></a>
                                                                </td>
                                                            </tr>
                                                    ...
                                                    <td class="text-14 lh-24 a-center c-white l-white pb-20"
                                                        ...
                                                        <a href="tel:+17384796719" target="_blank" class="link c-white"
                                                            style="text-decoration:none; color:#ffffff;"><span
                                                                class="link c-white"
                                                                style="text-decoration:none; color:#ffffff;">425-455-8497</span></a>

                                                        <br />
                                                        <a href="mailto:info@aris360.com" target="_blank"
                                                            class="link c-white"
                                                            style="text-decoration:none; color:#ffffff;"><span
                                                                class="link c-white"
                                                                style="text-decoration:none; color:#ffffff;">info@aris360.com</span></a>
                                                        - <a href="https://www.aris360.com" target="_blank" class="link c-white"
                                                            style="text-decoration:none; color:#ffffff;"><span
                                                                class="link c-white"
                                                                style="text-decoration:none; color:#ffffff;">www.aris360.com</span></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td class="img" width="117"
                                                                    style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                    <a href="#" target="_blank"><img
                                                                            src="{{'https://www.aris360.com/public/images/emails/appstore.png'}}" width="117"
                                                                ...
                                                                <td class="img" width="117"
                                                                    style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                    <a href="#" target="_blank"><img
                                                                            src="{{'https://www.aris360.com/public/images/emails/gplaystore.png'}}"
                                        ...
                                        <td class="text-12 lh-22 a-center c-grey- l-grey py-20"
                                            ...
                                            &nbsp;|&nbsp; <a href="#" target="_blank" class="link c-grey"
                                                style="text-decoration:none; color:#6e6e6e;"><span class="link c-grey"
                                                    ...
                                                    VERSION</span></a> &nbsp;|&nbsp; <a href="#" target="_blank"
                                                class="link c-grey" style="text-decoration:none; color:#6e6e6e;"><span
                                                    class="link c-grey"
