																							...
																							<table width="100%"
																								...
																								<tr>
																									<td class="fluid-img img-center pb-50"
																										...
																										<img src="{{'https://www.aris360.com/public/images/emails/mg2.png'}}"
																											width="200"
																											height="200"
																											border="0"
																											alt="" />
																								...
																								<tr>
																									<td class="title-36 a-center pb-15"
																										...
																										<strong>New Comment Added By {{$data['user']['email']}}</strong>
																									</td>
																								</tr>
																								<tr>
																										...
																										<table
																											...
																											<tr>
																												<td class="btn-16 c-white l-white"
																													...
																													<a href="{{url('/threads' . '/' . $data['forum_thread_id'])}}"
																														target="_blank"
																														class="link c-white"
																														style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
																														<span
																															class="link c-white"
																															style="text-decoration:none; color:#ffffff;">View Comment</span>
																													</a>
																												</td>
																											</tr>
																										</table>
