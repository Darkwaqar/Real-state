...
<head>
	...
	<!--<![endif]-->
	<title>Created A New Thread</title>
	<!--[if gte mso 9]>
																							...
																							<table width="100%"
																								...
																								<tr>
																									<td class="title-36 a-center pb-15"
																										...
																										<strong>You Have Created A New Thread ( {{$data['title']}} )</strong>
																									</td>
																								</tr>
																								<tr>
																										...
																										<table
																											...
																											<tr>
																												<td class="btn-16 c-white l-white"
																													...
																													<a href="{{url('/threads' . '/' . $data['id'])}}"
																														target="_blank"
																														class="link c-white"
																														style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
																														<span
																															class="link c-white"
																															style="text-decoration:none; color:#ffffff;">View Thread</span>
																													</a>
																												</td>
																											</tr>
																										</table>
