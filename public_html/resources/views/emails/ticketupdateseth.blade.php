																							...
																							<table width="100%"
																								...
																								<tr>
																									<td class="fluid-img img-center pb-50"
																										...
																										<img src="{{'https://www.aris360.com/public/images/emails/img5.png'}}"
																											width="200"
																											height="200"
																											border="0"
																											alt="" />
																								...
																								<tr>
																									<td class="title-36 a-center pb-15"
																										...
																										<strong>There Is An Update On ( {{$data['ticket']['complaint']['user_complaints']['first_name']}}  ) Ticket</strong>
																									</td>
																								</tr>
																								<tr>
																									<td class="text-16 lh-26 a-center pb-25"
																										...
																										<p><b>Ticket No: </b>{{isset($data['ticket']['complaint']['ticket_no']) ? $data['ticket']['complaint']['ticket_no'] : '' }}</p>
																										<p><b> Ticket Update Description: </b>{{isset($data['statusChangedDescription']) ? $data['statusChangedDescription'] : '' }}</p>
                                                                                                        <p><b> Ticket Update Status: </b>{{isset($data['ticket']['status']) ? $data['ticket']['status'] : '' }}</p>
                                                                                                        <p><b> Ticket Updated Admin: </b>{{isset($data['ticket']['ticket_updated_by']['first_name']) ? $data['ticket']['ticket_updated_by']['first_name'] : '' }}</p>
                                                                                                    </td>
																								</tr>
																								<tr>
																									<td class="py-4"
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
															...
															<tr>
																...
																<td class="img" width="34"
																	...
																	<a href="https://www.instagram.com/aris360llc/" target="_blank"><img
																			src="{{'https://www.aris360.com/public/images/emails/instagram-logo.png'}}"
																			width="34" height="34" border="0"
																			alt="" /></a>
																</td>
																<td class="img" width="15"
																...
																<td class="img" width="34"
																	...
																	<a href="https://linkedin.com/company/aris360llc/" target="_blank"><img
																			src="{{'https://www.aris360.com/public/images/emails/linkedin-logo.png'}}"
																			width="34" height="34" border="0"
																			alt="" /></a>
																</td>
																<td class="img" width="15"
																...
																<td class="img" width="34"
																	...
																	<a href="https://twitter.com/aris360llc" target="_blank"><img
																			src="{{'https://www.aris360.com/public/images/emails/twitter-logo.png'}}"
																			width="34" height="34" border="0"
																			alt="" /></a>
																</td>
															</tr>
												...
												<tr>
													<td class="text-14 lh-24 a-center c-white l-white pb-20"
														...
														5209 Lake Washington Blvd NE, Suite 220   Kirkland, WA 98033-7355
														<br />
														...
														- <a href="www.aris360.com" target="_blank" class="link c-white"
															style="text-decoration:none; color:#ffffff;"><span
																class="link c-white"
