...

{
    ...
    //     return $this->hasMany(UserSkills::class,'user_id'); //user can have multiple Experience with UserExperiences Model
    ...
    //query for realestateAgent page, it will be called in the controller
