...
class PropertiesInsertingMls extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'mls:insert';
        ...
        try {
            ...
            foreach ($propertiesOver9999 as $key => $jsonToArr) {
                ...
                // echo 'main if here =><br>';
                    ...
                    $property['OriginalEntryTimestamp']= isset($jsonToArr['OriginalEntryTimestamp']) ? Carbon::parse($jsonToArr['OriginalEntryTimestamp'])->setTimezone(config('app.timezone'))->format('Y-m-d h:i:s') : "";
                    $property['MlgCanView'] = isset($jsonToArr['MlgCanView']) ? $jsonToArr['MlgCanView'] : "";
                    $property['ClosePrice'] = isset($jsonToArr['ClosePrice']) ? $jsonToArr['ClosePrice'] : "";
                    $property['CloseDate'] = isset($jsonToArr['CloseDate']) ? $jsonToArr['CloseDate'] : "";
                    ...
                    $currentIdskz =  Properties::updateOrCreate(
                        [
                            ...
                            'PropertyAddress' => isset($jsonToArr['UnparsedAddress']) ? $jsonToArr['UnparsedAddress'] : "",
                            'Bedrooms' => isset($jsonToArr['BedroomsTotal']) ? $jsonToArr['BedroomsTotal'] : 0,
                            // 'BathroomsFull' => isset($jsonToArr['BathroomsFull']) ? $jsonToArr['BathroomsFull'] : 0,
                            'PropertyArea' => isset($jsonToArr['BuildingAreaTotal']) ? $jsonToArr['BuildingAreaTotal'] : 0,
                        ],
                        $property,
                    );
                    ...
                    if (isset($jsonToArr['Media'])) {
                        foreach ($jsonToArr['Media'] as $value) {
                            if(isset( $value)){
                                ...
                                // $media['s3buckettempurl'] = generateS3BucketUrl(basename($value['MediaURL']));
