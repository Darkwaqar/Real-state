...
// Add templates   routes as needed
Route::post('/agent/add-template', [TemplatesController::class, 'agentTemplatePost'])->name('agentTemplatePost');
Route::get('/agent/template', [TemplatesController::class, 'agentTemplate'])->name('agentTemplate');
Route::post('/delete-template', [TemplatesController::class, 'destroy'])->name('destroy');
